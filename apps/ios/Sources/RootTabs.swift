    ...
    private var phoneTabContent: some View {
        TabView(selection: self.selectedTabBinding) {
            ...
            SettingsProTab(
                ...
                approvalsStore: self.makeSettingsApprovalsStore(),
                appearanceStore: self.makeSettingsAppearanceStore(),
                deviceCapabilityStore: self.makeSettingsDeviceCapabilityStore(),
                deviceIdentityStore: self.makeSettingsDeviceIdentityStore(),
                ...
                shareInstructionStore: self.makeSettingsShareInstructionStore(),
                manualGatewayPortStore: self.makeSettingsManualGatewayPortStore(),
                manualGatewayEndpointStore: self.makeSettingsManualGatewayEndpointStore(),
                diagnosticsStore: self.makeSettingsDiagnosticsStore(),
                gatewayActivityStore: self.makeSettingsGatewayActivityStore(),
                gatewayAutoConnectStore: self.makeSettingsGatewayAutoConnectStore(),
                gatewayConnectionStore: self.makeSettingsGatewayConnectionStore(),
                gatewaySetupStatusStore: self.makeSettingsGatewaySetupStatusStore(),
...
extension RootTabs {
    ...
    private func setSidebarVisible(_ isVisible: Bool) {
        self.sidebarStore.send(.visibilityChanged(RootSidebarFeature.VisibilityChange(
            visibility: .init(isVisible: isVisible))))
    }
