...
struct AgentProTab: View {
    ...
    var clawHubQueryBinding: Binding<String> {
        Binding(
            get: { self.clawHubStore.query.value },
    ...
    var skillFilterBinding: Binding<String> {
        Binding(
            get: { self.skillFilterStore.searchText.value },
    ...
    var skillConfigMessages: [String: AgentSkillEditorMessage] {
    ...
    var cronActionStatusText: String? {
        self.cronActionStore.statusText.value
    }
...
struct AgentSkillEditorMessageText: Equatable, Sendable { var value: String }

struct AgentSkillEditorMessage: Equatable, Sendable {
    let kind: Kind
    let text: AgentSkillEditorMessageText
...
struct AgentClawHubSearchFeature {
    ...
    enum Action: Equatable, Sendable {
        ...
        struct InstallSlug: Equatable, Sendable {
            var slug: AgentClawHubInstallSlug
        }
...
struct AgentNavigationFeature {
    // swiftformat:disable redundantSendable
    struct AgentNavigationPath: Equatable, Sendable {
        var routes: [AgentRoute]
    }

    @ObservableState
    struct State: Equatable, Sendable {
        var navigationPathState = AgentNavigationPath(routes: [])
