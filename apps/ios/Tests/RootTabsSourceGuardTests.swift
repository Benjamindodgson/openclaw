...
struct RootTabsSourceGuardTests {
    ...
    @Test func `workboard create action surfaces unavailable reasons`() throws {
        ...
        #expect(source.contains("self.store.state.compactEmptyStatePresentation(gatewayAccess: self.gatewayAccess)"))
        #expect(source.contains("self.store.state.compactWriteControlsPresentation(gatewayAccess: self.gatewayAccess)"))
        #expect(source.contains("icon: self.compactEmptyStatePresentation.icon"))
        #expect(source.contains("title: self.compactEmptyStatePresentation.title"))
        #expect(source.contains("detail: self.compactEmptyStatePresentation.detail"))
        #expect(source.contains("value: self.compactEmptyStatePresentation.value"))
