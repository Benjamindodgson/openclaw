...
struct RootTabsSourceGuardTests {
    ...
    @Test func `agents direct route keeps single sidebar control`() throws {
        ...
        #expect(skillsSource.contains("self.skillPolicyMutationStore.send(.mutationStarted(key: busyKey))"))
        #expect(skillsSource.contains("self.skillPolicyMutationStore.send(.mutationFinished(key: busyKey))"))
        #expect(skillsSource.contains("self.skillPolicyMutationStore.send(.mutationSucceeded("))
        #expect(skillsSource.contains("self.skillPolicyMutationStore.send(.mutationFailed("))
        ...
        #expect(skillsSource.contains("self.skillEditorStore.send(.mutationStarted(key: key))"))
        #expect(skillsSource.contains("self.skillEditorStore.send(.mutationSucceeded(key: key, message: message))"))
        #expect(skillsSource.contains("self.skillEditorStore.send(.mutationFinished(key: key))"))
        #expect(skillsSource.contains("self.skillEditorStore.send(.mutationFailed("))
    ...
    @Test func `routed gateway pills open gateway settings`() throws {
        ...
        #expect(rootSource.contains("self.navigationStore.send(.sidebarNavigationPathChanged($0))"))
        ...
        #expect(navigationSource.contains("case startupSnapshotChanged(StartupSnapshot)"))
        #expect(navigationSource.contains("case startupPresentationEvaluationRequested(StartupSnapshot)"))
        #expect(navigationSource.contains("case autoOpenSettingsRequested(StartupSnapshot)"))
        ...
        #expect(navigationSource.contains("case quickSetupSnapshotChanged(QuickSetupSnapshot)"))
        #expect(navigationSource.contains("snapshot: RootPresentationFeature.QuickSetupSnapshot"))
        #expect(rootSource.contains(".quickSetupSnapshotChanged(RootPresentationFeature.QuickSetupSnapshot("))
        ...
        #expect(rootSource.contains("self.navigationStore.send(.settingsRouteSelected(route))"))
        #expect(rootSource.contains("self.navigationStore.send(.settingsRouteChanged(route))"))
        #expect(rootSource.contains("self.navigationStore.send(.sidebarSettingsRoutePushed(route))"))
        ...
        #expect(settingsTabSource.contains("set: { self.navigationStore.send(.navigationPathChanged($0)) }"))
        #expect(settingsTabSource.contains("self.navigationStore.send(.routeOpened(.notifications))"))
        #expect(settingsTabSource.contains("self.navigationStore.send(.initialRouteRequested(self.initialRoute))"))
    ...
    @Test func `push enrollment stays behind notification disclosure flow`() throws {
        ...
        #expect(actionsSource.contains("self.notificationStore.send(.remoteRegistrationRequested("))
        ...
        #expect(notificationSource.contains("case remoteRegistrationRequested(disclosureAccepted: Bool)"))
    ...
    @Test func `native chat uses gateway transport`() throws {
        ...
        #expect(channelsSource.contains("await self.store.send(.refreshRequested("))
        #expect(channelsSource.contains("await self.store.send(.operationRequested("))
