...
struct RootTabsSourceGuardTests {
    ...
    @Test func `phone control hub status text is typed presentation state`() throws {
        let source = try String(contentsOf: Self.phoneHubSourceURL(), encoding: .utf8)

        #expect(source.contains("struct RootTabsPhoneControlHubGatewayDisplayStatusText: Equatable, Sendable"))
        #expect(source.contains(
    ...
    @Test func `agents direct route keeps single sidebar control`() throws {
        ...
        #expect(source.contains("@Reducer\nstruct AgentOverviewLoadFeature"))
        #expect(source.contains("struct AgentNavigationPath: Equatable, Sendable"))
        #expect(source.contains("var navigationPathState = AgentNavigationPath(routes: [])"))
        #expect(source.contains("var navigationPath: [AgentRoute]"))
        #expect(source.contains("self.navigationPathState.routes"))
        #expect(source.contains("var path: AgentNavigationPath"))
        #expect(source.contains("state.navigationPathState = change.path"))
        #expect(!source.contains("var navigationPath: [AgentRoute] = []"))
        #expect(!source.contains("struct NavigationPathChange: Equatable, Sendable {\n            var path: [AgentRoute]"))
        #expect(!source.contains("state.navigationPath = change.path"))
        #expect(!source.contains("enum AgentRoute: Hashable {"))
        #expect(!source.contains("AgentProTab.AgentRoute"))
        #expect(!source.contains("navigationStore: StoreOf<AgentNavigationFeature> = Store("))
        #expect(!source.contains("overviewStore: StoreOf<AgentOverviewLoadFeature> = Store("))
        #expect(!source.contains("clawHubStore: StoreOf<AgentClawHubSearchFeature> = Store("))
        #expect(!source.contains("skillFilterStore: StoreOf<AgentSkillFilterFeature> = Store("))
        #expect(!source.contains("skillPolicyMutationStore: StoreOf<AgentSkillPolicyMutationFeature> = Store("))
        #expect(!source.contains("skillEditorStore: StoreOf<AgentSkillEditorFeature> = Store("))
        #expect(!source.contains("cronActionStore: StoreOf<AgentCronActionFeature> = Store("))
        #expect(!source.contains("selectionStore: StoreOf<AgentSelectionFeature> = Store("))
        #expect(!source.contains("filterStore: StoreOf<AgentOverviewFilterFeature> = Store("))
        ...
        #expect(source.contains("navigationStore: StoreOf<AgentNavigationFeature>? = nil"))
        #expect(source.contains("navigationStoreFactory: () -> StoreOf<AgentNavigationFeature>"))
        #expect(source.contains("overviewStore: StoreOf<AgentOverviewLoadFeature>? = nil"))
        #expect(source.contains("overviewStoreFactory: () -> StoreOf<AgentOverviewLoadFeature>"))
        #expect(source.contains("clawHubStore: StoreOf<AgentClawHubSearchFeature>? = nil"))
        #expect(source.contains("clawHubStoreFactory: () -> StoreOf<AgentClawHubSearchFeature>"))
        #expect(source.contains("skillFilterStore: StoreOf<AgentSkillFilterFeature>? = nil"))
        #expect(source.contains("skillFilterStoreFactory: () -> StoreOf<AgentSkillFilterFeature>"))
        #expect(source.contains("skillPolicyMutationStore: StoreOf<AgentSkillPolicyMutationFeature>? = nil"))
        #expect(source.contains("skillPolicyMutationStoreFactory: () -> StoreOf<AgentSkillPolicyMutationFeature>"))
        #expect(source.contains("skillEditorStore: StoreOf<AgentSkillEditorFeature>? = nil"))
        #expect(source.contains("skillEditorStoreFactory: () -> StoreOf<AgentSkillEditorFeature>"))
        #expect(source.contains("cronActionStore: StoreOf<AgentCronActionFeature>? = nil"))
        #expect(source.contains("cronActionStoreFactory: () -> StoreOf<AgentCronActionFeature>"))
        #expect(source.contains("selectionStore: StoreOf<AgentSelectionFeature>? = nil"))
        #expect(source.contains("selectionStoreFactory: () -> StoreOf<AgentSelectionFeature>"))
        #expect(source.contains("filterStore: StoreOf<AgentOverviewFilterFeature>? = nil"))
        #expect(source.contains("filterStoreFactory: () -> StoreOf<AgentOverviewFilterFeature>"))
        #expect(source.contains("let resolvedNavigationStore = navigationStore ?? navigationStoreFactory()"))
        #expect(source.contains(
        ...
        #expect(overviewLoadFeature.contains("var nextRefreshRequestID = AgentOverviewRefreshRequestID(value: 0)"))
        ...
        #expect(overviewLoadFeature.contains("state.nextRefreshRequestID.value += 1"))
        #expect(overviewLoadFeature.contains("id: state.nextRefreshRequestID"))
        ...
        #expect(!overviewLoadFeature.contains("var nextRefreshRequestID = 0"))
        ...
        #expect(source.contains("struct AgentClawHubSearchResults: Equatable, Sendable"))
        ...
        #expect(clawHubSearchFeature.contains("var resultEntries = AgentClawHubSearchResults()"))
        #expect(clawHubSearchFeature.contains("var results: [ClawHubSearchResultLite] {\n            self.resultEntries.values\n        }"))
        ...
        #expect(!clawHubSearchFeature.contains("var results: [ClawHubSearchResultLite] = []"))
        #expect(!clawHubSearchFeature.contains("state.results = response.results"))
        ...
        #expect(source.contains("struct AgentSkillPolicyMutationBusyKeys: Equatable, Sendable"))
        #expect(source.contains("Set(self.skillPolicyMutationStore.busyKeys.map(\\.value))"))
        #expect(skillPolicyMutationFeature.contains("var busyKeyEntries = AgentSkillPolicyMutationBusyKeys()"))
        #expect(skillPolicyMutationFeature.contains("var busyKeys: Set<AgentSkillPolicyMutationKey>"))
        #expect(skillPolicyMutationFeature.contains("self.busyKeyEntries.values"))
        ...
        #expect(skillPolicyMutationFeature.contains("state.busyKeyEntries.values.insert(mutation.key)"))
        #expect(skillPolicyMutationFeature.contains("state.busyKeyEntries.values.remove(mutation.key)"))
        ...
        #expect(source.contains("struct AgentSkillEditorAPIKeyDrafts: Equatable, Sendable"))
        #expect(source.contains(
            "Dictionary(uniqueKeysWithValues: self.skillEditorStore.apiKeyDrafts.map { ($0.key.value, $0.value.value) })"))
        #expect(skillEditorFeature.contains("var apiKeyDraftEntries = AgentSkillEditorAPIKeyDrafts()"))
        #expect(skillEditorFeature.contains(
            "var apiKeyDrafts: [AgentSkillEditorAPIKeyDraftKey: AgentSkillEditorAPIKeyDraftValue]"))
        #expect(skillEditorFeature.contains("self.apiKeyDraftEntries.values"))
        ...
        #expect(skillEditorFeature.contains("state.apiKeyDraftEntries.values[draft.key] = draft.value"))
        #expect(skillEditorFeature.contains("state.apiKeyDraftEntries.values[draft.key] = nil"))
        ...
        #expect(source.contains("struct AgentSkillEditorMessages: Equatable, Sendable"))
        #expect(source.contains("struct AgentSkillEditorBusyKeys: Equatable, Sendable"))
        ...
        #expect(skillEditorFeature.contains("var busyKeyEntries = AgentSkillEditorBusyKeys()"))
        #expect(skillEditorFeature.contains("var busyKeys: Set<AgentSkillEditorMutationKey>"))
        #expect(skillEditorFeature.contains("self.busyKeyEntries.values"))
        #expect(skillEditorFeature.contains("var messageEntries = AgentSkillEditorMessages()"))
        #expect(skillEditorFeature.contains("var messages: [AgentSkillEditorMutationKey: AgentSkillEditorMessage]"))
        #expect(skillEditorFeature.contains("self.messageEntries.values"))
        ...
        #expect(source.contains("state.busyKeyEntries.values.insert(mutation.key)"))
        #expect(source.contains("state.messageEntries.values[mutation.key] = nil"))
        #expect(source.contains("state.messageEntries.values[result.key]"))
        #expect(source.contains("state.busyKeyEntries.values.remove(mutation.key)"))
        #expect(source.contains("state.busyKeyEntries.values.remove(failure.key)"))
        #expect(source.contains("state.messageEntries.values[failure.key]"))
        ...
        #expect(source.contains("struct AgentCronActionBusyIDs: Equatable, Sendable"))
        #expect(source.contains("Set(self.cronActionStore.busyIDs.map(\\.value))"))
        #expect(cronActionFeature.contains("var busyIDEntries = AgentCronActionBusyIDs()"))
        ...
        #expect(cronActionFeature.contains("state.busyIDEntries.values.insert(action.id)"))
        #expect(cronActionFeature.contains("state.busyIDEntries.values.remove(action.id)"))
        #expect(cronActionFeature.contains("state.busyIDEntries.values.remove(failure.id)"))
        ...
        #expect(dreamingSource.contains("store: StoreOf<AgentDreamingDestinationFeature>? = nil"))
        #expect(dreamingSource.contains("storeFactory: () -> StoreOf<AgentDreamingDestinationFeature>"))
        #expect(dreamingSource.contains("let resolvedStore = store ?? storeFactory()"))
        #expect(!dreamingSource.contains("store: StoreOf<AgentDreamingDestinationFeature> = Store("))
        ...
        #expect(dreamingSource.contains("self.store.state.dreamingEntryTitle(entry)"))
        #expect(dreamingSource.contains("self.store.state.dreamingEntryDetail(entry)"))
        #expect(dreamingSource.contains("self.store.state.dreamingPhaseState(phase.status)"))
        ...
        #expect(!dreamingSource.contains("private func dreamingEntryTitle(_ entry: DreamingEntryLite)"))
        #expect(!dreamingSource.contains("private func dreamingEntryDetail(_ entry: DreamingEntryLite)"))
        #expect(!dreamingSource.contains("private func dreamingPhaseState(_ phase: DreamingPhaseStatusLite)"))
    ...
    @Test func `agent dreaming maintenance response action is typed`() throws {
        ...
        #expect(feature.contains("func dreamingEntryTitle(_ entry: DreamingEntryLite) -> String"))
        #expect(feature.contains("func dreamingEntryDetail(_ entry: DreamingEntryLite) -> String"))
        #expect(feature.contains("func dreamingPhaseState(_ phase: DreamingPhaseStatusLite) -> String"))
    ...
    @Test func `talk speakerphone persistence is reducer effect owned`() throws {
        ...
        #expect(talkSource.contains("struct PresentationSnapshotChange: Equatable, Sendable"))
        ...
        #expect(talkSource.contains("struct TalkProPresentationSnapshot: Equatable, Sendable"))
        ...
        #expect(talkSource.contains("var presentationSnapshot = TalkProPresentationSnapshot()"))
        #expect(talkSource.contains(
        ...
        #expect(talkSource.contains("var presentation: TalkProState"))
        #expect(talkSource.contains(".init(gatewayConnected: self.gatewayConnected, snapshot: self.presentationSnapshot)"))
        #expect(talkSource.contains("var waveformMode: TalkProWaveformMode"))
        ...
        #expect(talkSource.contains("case presentationSnapshotChanged(PresentationSnapshotChange)"))
        ...
        #expect(talkSource.contains("state.presentationSnapshot = change.snapshot"))
        ...
        #expect(talkSource.contains("private var currentPresentationSnapshot: TalkProPresentationSnapshot"))
        #expect(talkSource.contains("private func syncPresentationState()"))
        #expect(talkSource.contains("self.store.send(.presentationSnapshotChanged(.init(snapshot: snapshot)))"))
        #expect(talkSource.contains("self.store.send(.gatewayConnectionChanged(.init(status: .init(isConnected: connected))))"))
        #expect(!talkSource.contains("TalkProState(\n            gatewayConnected: self.store.gatewayConnected"))
    ...
    @Test func `chat talk toggle is reducer effect owned`() throws {
        ...
        #expect(chatSource.contains("struct ChatTalkControlSnapshot: Equatable, Sendable"))
        #expect(chatSource.contains("struct SnapshotChange: Equatable, Sendable"))
        #expect(chatSource.contains("var sessionKey: ChatSessionKey?"))
        #expect(chatSource.contains("var talkEnabled: TalkEnabled"))
        #expect(chatSource.contains("var snapshot = ChatTalkControlSnapshot()"))
        #expect(chatSource.contains("case snapshotChanged(SnapshotChange)"))
        #expect(chatSource.contains("case toggleRequested(ToggleRequest)"))
        #expect(chatSource.contains("state.snapshot = change.snapshot"))
        ...
        #expect(chatSource.contains("talkEnabled: .init(isEnabled: control.isEnabled)"))
    ...
    @Test func `root canvas debug status is reducer effect owned`() throws {
        ...
        #expect(featureSource.contains("struct GatewayDisplayStatusText: Equatable, Sendable"))
        #expect(featureSource.contains("var gatewayDisplayStatusText: GatewayDisplayStatusText"))
        #expect(featureSource.contains("struct GatewayServerName: Equatable, Sendable"))
        #expect(featureSource.contains("var gatewayServerName: GatewayServerName"))
        #expect(featureSource.contains("struct GatewayRemoteAddress: Equatable, Sendable"))
        #expect(featureSource.contains("var gatewayRemoteAddress: GatewayRemoteAddress"))
        #expect(featureSource.contains(
            "init(appModel: NodeAppModel, enabled: RootCanvasDebugStatusFeature.DebugStatusEnabled)"))
        #expect(featureSource.contains("gatewayDisplayStatusText: .init(value: appModel.gatewayDisplayStatusText)"))
        ...
        #expect(featureSource.contains("let title = snapshot.gatewayDisplayStatusText.trimmed"))
        #expect(featureSource.contains("let subtitle = snapshot.gatewayServerName.value ?? snapshot.gatewayRemoteAddress.value"))
        ...
        #expect(!featureSource.contains("var gatewayDisplayStatusText: String"))
        #expect(!featureSource.contains("var gatewayServerName: String?"))
        #expect(!featureSource.contains("var gatewayRemoteAddress: String?"))
        #expect(!featureSource.contains("let title = snapshot.gatewayDisplayStatusText.trimmingCharacters"))
        #expect(!featureSource.contains("let subtitle = snapshot.gatewayServerName ?? snapshot.gatewayRemoteAddress"))
    ...
    @Test func `root tca store factories live outside root tabs`() throws {
        ...
        #expect(rootSource.contains("navigationStore: StoreOf<RootNavigationSelectionFeature>? = nil"))
        #expect(rootSource.contains("navigationStoreFactory: () -> StoreOf<RootNavigationSelectionFeature>"))
        #expect(rootSource.contains("sidebarStore: StoreOf<RootSidebarFeature>? = nil"))
        #expect(rootSource.contains("sidebarStoreFactory: () -> StoreOf<RootSidebarFeature>"))
        #expect(rootSource.contains("launchStore: StoreOf<RootLaunchFeature>? = nil"))
        #expect(rootSource.contains("launchStoreFactory: () -> StoreOf<RootLaunchFeature>"))
        #expect(rootSource.contains("voiceWakeToastStore: StoreOf<RootVoiceWakeToastFeature>? = nil"))
        #expect(rootSource.contains("voiceWakeToastStoreFactory: () -> StoreOf<RootVoiceWakeToastFeature>"))
        #expect(rootSource.contains("presentationStore: StoreOf<RootPresentationFeature>? = nil"))
        #expect(rootSource.contains("presentationStoreFactory: () -> StoreOf<RootPresentationFeature>"))
        #expect(rootSource.contains("idleTimerStore: StoreOf<RootIdleTimerFeature>? = nil"))
        #expect(rootSource.contains("idleTimerStoreFactory: () -> StoreOf<RootIdleTimerFeature>"))
        #expect(rootSource.contains("homeCanvasStore: StoreOf<RootHomeCanvasFeature>? = nil"))
        #expect(rootSource.contains("homeCanvasStoreFactory: () -> StoreOf<RootHomeCanvasFeature>"))
        #expect(rootSource.contains("let resolvedNavigationStore = navigationStore ?? navigationStoreFactory()"))
        #expect(rootSource.contains("let resolvedVoiceWakeToastStore = voiceWakeToastStore ?? voiceWakeToastStoreFactory()"))
        #expect(rootSource.contains("let resolvedHomeCanvasStore = homeCanvasStore ?? homeCanvasStoreFactory()"))
        ...
        #expect(!rootSource.contains("navigationStore: StoreOf<RootNavigationSelectionFeature> = Store("))
        #expect(!rootSource.contains("sidebarStore: StoreOf<RootSidebarFeature> = Store("))
        #expect(!rootSource.contains("launchStore: StoreOf<RootLaunchFeature> = Store("))
        #expect(!rootSource.contains("voiceWakeToastStore: StoreOf<RootVoiceWakeToastFeature> = Store("))
        #expect(!rootSource.contains("presentationStore: StoreOf<RootPresentationFeature> = Store("))
        #expect(!rootSource.contains("idleTimerStore: StoreOf<RootIdleTimerFeature> = Store("))
        #expect(!rootSource.contains("homeCanvasStore: StoreOf<RootHomeCanvasFeature> = Store("))
    ...
    @Test func `gateway quick setup response action is typed`() throws {
        ...
        #expect(quickSetupSource.contains("store: StoreOf<GatewayQuickSetupFeature>? = nil"))
        #expect(quickSetupSource.contains("storeFactory: () -> StoreOf<GatewayQuickSetupFeature>"))
        #expect(quickSetupSource.contains("let resolvedStore = store ?? storeFactory()"))
        #expect(!quickSetupSource.contains("store: StoreOf<GatewayQuickSetupFeature> = Store("))
    ...
    @Test func `voice wake trigger word change action is typed`() throws {
        ...
        #expect(source.contains("store: StoreOf<VoiceWakeWordsSettingsFeature>? = nil"))
        #expect(source.contains("storeFactory: () -> StoreOf<VoiceWakeWordsSettingsFeature>"))
        #expect(source.contains("let resolvedStore = store ?? storeFactory()"))
        ...
        #expect(!source.contains("init(store: StoreOf<VoiceWakeWordsSettingsFeature> = Store("))
    }
    ...
    @Test func `phone hub clears detail path before root tab handoff`() throws {
        ...
        #expect(source.contains("case navigationPathChanged(NavigationPathChange)"))
        #expect(source.contains("struct PhoneControlHubNavigationPath: Equatable, Sendable"))
        #expect(source.contains("var navigationPathState = PhoneControlHubNavigationPath(destinations: [])"))
        #expect(source.contains("var navigationPath: [RootTabs.SidebarDestination]"))
        #expect(source.contains("self.navigationPathState.destinations"))
        #expect(source.contains("var path: PhoneControlHubNavigationPath"))
        #expect(source.contains("state.navigationPathState.destinations.append(destination)"))
        #expect(source.contains("state.navigationPathState.destinations.removeLast()"))
        #expect(source.contains("state.navigationPathState = .init(destinations: [destination])"))
        #expect(source.contains("state.navigationPathState = change.path"))
        #expect(source.contains("state.navigationPathState = .init(destinations: [])"))
        #expect(source.contains(
            "set: { self.store.send(.navigationPathChanged(.init(path: .init(destinations: $0)))) }"))
        #expect(!source.contains("var navigationPath: [RootTabs.SidebarDestination] = []"))
        #expect(!source.contains("var path: [RootTabs.SidebarDestination]"))
        #expect(!source.contains("state.navigationPath = change.path"))
    ...
    @Test func `workboard create action surfaces unavailable reasons`() throws {
        ...
        let archiveFunction = try Self.extract(
            ...
            to: "private func dispatchCards() async")
        let newCardButtonSource = try Self.extract(
            screenSource,
            from: "private func newCardButton(expands: Bool) -> some View",
            to: "private var compactBoardScopeMenu: some View")
        let createSheetSource = try Self.extract(
            screenSource,
            from: "private var createCardSheet: some View",
            to: "private var refreshTaskID: String")
        ...
        #expect(source.contains("store: StoreOf<IPadWorkboardFeature>? = nil"))
        #expect(source.contains("storeFactory: () -> StoreOf<IPadWorkboardFeature>"))
        #expect(source.contains("let resolvedStore = store ?? storeFactory()"))
        #expect(!source.contains("store: StoreOf<IPadWorkboardFeature> = Store("))
        ...
        #expect(source.contains("struct IPadWorkboardStatusFilterOption: Equatable, Identifiable, Sendable"))
        #expect(source.contains("let isSelected: Bool"))
        #expect(source.contains("struct IPadWorkboardStatusFilterControlPresentation: Equatable, Sendable"))
        #expect(source.contains("var statusFilterControlPresentation: IPadWorkboardStatusFilterControlPresentation"))
        #expect(source.contains("statusFilterControlPresentation: self.statusFilterControlPresentation"))
        #expect(source.contains("pickerTitle: \"Scope\""))
        #expect(source.contains("menuTitle: \"Status\""))
        #expect(source.contains("selectedFilter: self.selectedStatus.value"))
        #expect(source.contains("selectedLabel: IPadWorkboardDefaults.label(for: self.selectedStatus.value)"))
        #expect(source.contains("selectorIconSystemName: \"chevron.up.chevron.down\""))
        #expect(source.contains("options: Self.statusFilterOptions(\n                    for: self.statusValues"))
        #expect(source.contains("compactOptions: Self.statusFilterOptions(\n                    for: self.compactStatuses"))
        #expect(source.contains("selectedStatus: self.selectedStatus.value"))
        #expect(source.contains("isSelected: status == selectedStatus"))
        #expect(source.contains("Picker(self.statusFilterControlPresentation.pickerTitle"))
        #expect(source.contains("ForEach(self.statusFilterControlPresentation.options)"))
        #expect(source.contains("ForEach(self.statusFilterControlPresentation.compactOptions)"))
        #expect(source.contains("private var statusFilterMenuItems: some View"))
        #expect(source.contains("Text(self.statusFilterControlPresentation.menuTitle)"))
        #expect(source.contains("Text(self.statusFilterControlPresentation.selectedLabel)"))
        #expect(source.contains("Image(systemName: self.statusFilterControlPresentation.selectorIconSystemName)"))
        #expect(source.contains("get: { self.statusFilterControlPresentation.selectedFilter }"))
        #expect(source.contains("Button(option.title)"))
        #expect(source.contains("status: .init(value: option.id)"))
        #expect(source.contains(".accessibilityLabel(option.accessibilityLabel)"))
        #expect(!source.contains("Picker(\"Scope\", selection: self.selectedStatusBinding)"))
        #expect(!source.contains("Text(\"Status\")"))
        #expect(!source.contains("Button(\"Active\")"))
        #expect(!source.contains("self.compactStatusChip(\"active\")"))
        ...
        #expect(source.contains("struct IPadWorkboardQueryFieldPresentation: Equatable, Sendable"))
        #expect(source.contains("var queryFieldPresentation: IPadWorkboardQueryFieldPresentation"))
        #expect(source.contains("text: self.query.value"))
        #expect(source.contains("placeholder: \"Search cards\""))
        #expect(source.contains("iconSystemName: \"magnifyingglass\""))
        #expect(source.contains("clearButtonSystemName: \"xmark.circle.fill\""))
        #expect(source.contains("showsClearButton: !self.query.value.isEmpty"))
        #expect(source.contains("private var searchField: some View"))
        #expect(source.contains("queryFieldPresentation: self.queryFieldPresentation"))
        #expect(source.contains("let presentation = self.screenPresentation.queryFieldPresentation"))
        #expect(source.contains("Image(systemName: presentation.iconSystemName)"))
        #expect(source.contains("TextField(presentation.placeholder, text: self.queryBinding)"))
        #expect(source.contains("Image(systemName: presentation.clearButtonSystemName)"))
        #expect(source.contains("get: { self.screenPresentation.queryFieldPresentation.text }"))
        #expect(source.contains("if presentation.showsClearButton"))
        #expect(!source.contains("let presentation = self.store.queryFieldPresentation"))
        #expect(!source.contains("get: { self.store.queryFieldPresentation.text }"))
        #expect(!source.contains("TextField(\"Search cards\", text: self.queryBinding)"))
        ...
        #expect(source.contains("get: { self.createCardPresentation.sheet.titleText }"))
        #expect(source.contains("get: { self.createCardPresentation.sheet.notesText }"))
        ...
        #expect(source.contains("struct IPadWorkboardCards: Equatable, Sendable"))
        #expect(source.contains("var cardEntries = IPadWorkboardCards()"))
        #expect(source.contains("var cards: [IPadWorkboardCard] {\n            self.cardEntries.values\n        }"))
        #expect(source.contains("var runningCardCount: Int"))
        #expect(source.contains("var blockedCardCount: Int"))
        #expect(source.contains("enum IPadWorkboardMetricTone: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardMetricPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("var metricPresentations: [IPadWorkboardMetricPresentation]"))
        #expect(source.contains("iconSystemName: \"tray.full\""))
        #expect(source.contains("iconSystemName: \"figure.run\""))
        #expect(source.contains("iconSystemName: \"exclamationmark.triangle\""))
        #expect(source.contains("tone: .accent"))
        #expect(source.contains("tone: .ok"))
        #expect(source.contains("tone: .warn"))
        #expect(source.contains("metricPresentations: self.metricPresentations"))
        #expect(source.contains("self.screenPresentation.metricPresentations.map { presentation in"))
        #expect(!source.contains("self.store.metricPresentations.map { presentation in"))
        #expect(source.contains("icon: presentation.iconSystemName"))
        #expect(source.contains("title: presentation.title"))
        #expect(source.contains("value: presentation.value"))
        #expect(source.contains("color: Self.metricColor(for: presentation.tone)"))
        #expect(source.contains("private static func metricColor(for tone: IPadWorkboardMetricTone) -> Color"))
        #expect(!source.contains("value: \"\\(self.store.runningCardCount)\""))
        #expect(!source.contains("value: \"\\(self.store.blockedCardCount)\""))
        #expect(!source.contains("ProMetric(\n                icon: \"tray.full\""))
        #expect(!source.contains("self.store.cards.count(where: { $0.status == \"running\" })"))
        #expect(!source.contains("self.store.cards.count(where: { $0.status == \"blocked\" })"))
        #expect(source.contains("var filteredCardCount: Int"))
        ...
        #expect(source.contains("struct IPadWorkboardQueueRowItemPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("var queueRowItemPresentations: [IPadWorkboardQueueRowItemPresentation]"))
        #expect(screenSource.contains("presentation.rowItemPresentations"))
        #expect(!screenSource.contains("self.store.queueRowItemPresentations"))
        #expect(!source.contains("Text(\"\\(self.store.filteredCards.count) cards\")"))
        #expect(!screenSource.contains("self.store.filteredCards"))
        #expect(source.contains("var kanbanColumnPresentations: [IPadWorkboardKanbanColumnPresentation]"))
        #expect(source.contains("func kanbanColumnPresentation(status: String) -> IPadWorkboardKanbanColumnPresentation"))
        #expect(source.contains("kanbanColumnPresentations: self.kanbanColumnPresentations"))
        #expect(screenSource.contains("ForEach(self.screenPresentation.kanbanColumnPresentations)"))
        #expect(!screenSource.contains("ForEach(self.store.kanbanColumnPresentations)"))
        #expect(!screenSource.contains("let cards = self.store.state.cards(forKanbanStatus: status)"))
        #expect(!screenSource.contains("cards: cards"))
        ...
        #expect(!source.contains("IPadWorkboardFeature.State.cardsForKanbanStatus("))
        #expect(source.contains("state.cardEntries = .init()"))
        #expect(!source.contains("var cards: [IPadWorkboardCard] = []"))
        #expect(!source.contains("state.cards = []"))
        #expect(!source.contains("@State private var statuses"))
        #expect(source.contains("struct IPadWorkboardStatus: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardStatuses: Equatable, Sendable"))
        #expect(source.contains("var statusEntries = IPadWorkboardStatuses()"))
        #expect(source.contains("var statuses: [IPadWorkboardStatus] {\n            self.statusEntries.values\n        }"))
        #expect(source.contains("self.statusEntries = .init(values: Self.normalizedStatuses(response.statuses))"))
        ...
        #expect(source.contains("Self.boardScopeLabel(for: self.selectedBoardID.value)"))
        #expect(source.contains("static func normalizedScopeID(_ value: String?) -> String"))
        #expect(source.contains("static func boardID(for card: IPadWorkboardCard) -> String"))
        #expect(source.contains("static func boardScopeLabel(for boardID: String) -> String"))
        #expect(source.contains("static func boardScopeOptions(knownBoardIDs: [String], cardBoardIDs: [String]) -> [String]"))
        #expect(source.contains("Self.normalizedScopeID(self.selectedBoardID.value)"))
        #expect(source.contains("State.normalizedScopeID(change.boardID.value)"))
        #expect(!source.contains("IPadWorkboardScreen.normalizedScopeID("))
        #expect(!source.contains("IPadWorkboardScreen.boardID("))
        #expect(!source.contains("IPadWorkboardScreen.boardScopeLabel("))
        #expect(!source.contains("IPadWorkboardScreen.boardScopeOptions("))
        #expect(source.contains("let board = self.selectedBoardID.value.isEmpty ? \"all\" : self.selectedBoardID.value"))
        #expect(!source.contains("self.store.selectedBoardID.value.isEmpty ? \"all\""))
        #expect(source.contains("struct IPadWorkboardBoardScopeOption: Equatable, Identifiable, Sendable"))
        #expect(source.contains("struct IPadWorkboardBoardScopeMenuPresentation: Equatable, Sendable"))
        #expect(source.contains("var boardScopeMenuPresentation: IPadWorkboardBoardScopeMenuPresentation"))
        #expect(source.contains("boardScopeMenuPresentation: self.boardScopeMenuPresentation"))
        #expect(source.contains("title: \"Board\""))
        #expect(source.contains("selectedLabel: self.boardScopeLabel"))
        #expect(source.contains("leadingIconSystemName: \"rectangle.stack\""))
        #expect(source.contains("selectorIconSystemName: \"chevron.up.chevron.down\""))
        #expect(source.contains("accessibilityLabel: \"Workboard board scope\""))
        #expect(source.contains("private var boardScopeMenuItems: some View"))
        #expect(source.contains("ForEach(self.boardScopeMenuPresentation.options)"))
        #expect(source.contains("Button(option.title)"))
        #expect(source.contains("boardID: .init(value: option.id)"))
        #expect(source.contains("Text(self.boardScopeMenuPresentation.selectedLabel)"))
        #expect(source.contains("Image(systemName: self.boardScopeMenuPresentation.leadingIconSystemName)"))
        #expect(source.contains("Image(systemName: self.boardScopeMenuPresentation.selectorIconSystemName)"))
        #expect(source.contains(".accessibilityLabel(self.boardScopeMenuPresentation.accessibilityLabel)"))
        #expect(!source.contains("private var boardScopeOptions: [String]"))
        #expect(!source.contains("private var boardScopeLabel: String"))
        #expect(!source.contains("Button(\"All boards\")"))
        #expect(!source.contains("Text(self.boardScopeLabel)"))
        #expect(source.contains("var workboardSubtitle: String"))
        #expect(source.contains("struct IPadWorkboardScreenChromePresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardQueueSummaryPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardRefreshControlPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCompactEmptyStatePresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCompactCardsPanelPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCompactWriteUnavailablePresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCompactWriteControlsPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardGatewayAccess: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardScreenPresentation: Equatable, Sendable"))
        #expect(source.contains("var screenChromePresentation: IPadWorkboardScreenChromePresentation"))
        #expect(source.contains("var queueSummaryPresentation: IPadWorkboardQueueSummaryPresentation"))
        #expect(source.contains("var refreshControlPresentation: IPadWorkboardRefreshControlPresentation"))
        #expect(source.contains("static func gatewayAccess("))
        #expect(source.contains("isAppleReviewDemoModeEnabled: Bool"))
        #expect(source.contains("canRead: isOperatorGatewayConnected"))
        #expect(source.contains("canWrite: isOperatorGatewayConnected && !isAppleReviewDemoModeEnabled"))
        #expect(source.contains("private var gatewayAccess: IPadWorkboardGatewayAccess"))
        #expect(source.contains("IPadWorkboardFeature.State.gatewayAccess("))
        #expect(source.contains("let showsWriteControls: Bool"))
        ...
        #expect(source.contains("func compactCardsPanelPresentation("))
        ...
        #expect(source.contains("self.screenPresentation.compactWriteControlsPresentation"))
        ...
        #expect(source.contains("title: presentation.emptyStatePresentation.title"))
        #expect(source.contains("detail: presentation.emptyStatePresentation.detail"))
        #expect(source.contains("value: presentation.emptyStatePresentation.value"))
        #expect(source.contains("if self.compactWriteControlsPresentation.showsWriteControls"))
        #expect(source.contains("Text(self.compactWriteControlsPresentation.unavailablePresentation.message)"))
        #expect(!source.contains("icon: self.canRead ? \"tray\" : \"wifi.slash\""))
        #expect(!source.contains("title: self.canRead ? \"No cards\" : \"No cards loaded\""))
        #expect(!source.contains("value: self.canRead ? \"empty\" : nil"))
        #expect(!source.contains("if self.canWrite {\n                    HStack(spacing: 8)"))
        ...
        #expect(!screenSource.contains("Text(Self.compactWriteUnavailableMessage(canRead: self.canRead))"))
        #expect(!screenSource.contains("static func compactWriteUnavailableMessage"))
        #expect(source.contains("var screenPresentation: IPadWorkboardScreenPresentation"))
        #expect(source.contains("func screenPresentation("))
        #expect(source.contains("gatewayAccess: IPadWorkboardGatewayAccess"))
        #expect(source.contains("let refreshTaskID: String"))
        #expect(source.contains(
            "func refreshTaskID(gatewayAccess: IPadWorkboardGatewayAccess, sceneIsActive: Bool) -> String"))
        #expect(source.contains("refreshTaskID: self.refreshTaskID("))
        #expect(source.contains("screenChromePresentation: self.screenChromePresentation"))
        #expect(source.contains("queueSummaryPresentation: self.queueSummaryPresentation"))
        #expect(source.contains("refreshControlPresentation: self.refreshControlPresentation"))
        #expect(source.contains("private var screenPresentation: IPadWorkboardScreenPresentation"))
        #expect(source.contains("self.store.state.screenPresentation("))
        #expect(source.contains("gatewayAccess: self.gatewayAccess"))
        #expect(source.contains("title: self.screenPresentation.screenChromePresentation.title"))
        #expect(source.contains("subtitle: self.screenPresentation.screenChromePresentation.subtitle"))
        ...
        #expect(!source.contains("self.canRead ? \"connected\" : \"offline\""))
        #expect(!source.contains("func screenPresentation(canRead: Bool"))
        #expect(!source.contains("func refreshTaskID(canRead: Bool"))
        #expect(source.contains("Text(self.queueSummaryPresentation.cardCountLabel)"))
        #expect(source.contains("value: presentation.queueSummaryPresentation.value"))
        #expect(!source.contains("value: self.queueSummaryPresentation.value"))
        #expect(source.contains("title: \"Refresh\""))
        #expect(source.contains("iconSystemName: \"arrow.clockwise\""))
        #expect(source.contains("compactAccessibilityLabel: \"Refresh workboard\""))
        #expect(source.contains("Label(\n                            self.refreshControlPresentation.title,"))
        #expect(source.contains("systemImage: self.refreshControlPresentation.iconSystemName"))
        #expect(source.contains("Image(systemName: self.refreshControlPresentation.iconSystemName)"))
        #expect(source.contains("if self.refreshControlPresentation.showsProgress"))
        #expect(source.contains(".accessibilityLabel(self.refreshControlPresentation.compactAccessibilityLabel)"))
        #expect(!source.contains("Label(\"Refresh\", systemImage: \"arrow.clockwise\")"))
        #expect(!source.contains(".accessibilityLabel(\"Refresh workboard\")"))
        #expect(!source.contains("IPadSidebarScreenChrome(\n            title: \"Workboard\""))
        #expect(!source.contains("subtitle: self.store.workboardSubtitle"))
        #expect(!source.contains("Text(\"\\(self.store.filteredCardCount) cards\")"))
        #expect(!source.contains("subtitle: self.currentWorkboardSubtitle"))
        #expect(!source.contains("private var currentWorkboardSubtitle"))
        #expect(!source.contains("var selectedBoardID = \"\""))
        #expect(source.contains("struct IPadWorkboardKnownBoardID: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardKnownBoardIDs: Equatable, Sendable"))
        #expect(source.contains("var knownBoardIDEntries = IPadWorkboardKnownBoardIDs()"))
        #expect(source.contains("var knownBoardIDs: [IPadWorkboardKnownBoardID] {\n            self.knownBoardIDEntries.values\n        }"))
        #expect(source.contains("self.knownBoardIDEntries = .init(values: boardIDs.map { .init(value: $0) })"))
        #expect(source.contains("var knownBoardIDValues: [String]"))
        #expect(source.contains("knownBoardIDs: self.knownBoardIDValues"))
        #expect(!source.contains("var knownBoardIDs: [IPadWorkboardKnownBoardID] = []"))
        #expect(!source.contains("self.knownBoardIDs = boardIDs.map"))
        ...
        #expect(source.contains("enum IPadWorkboardPresentedSheetPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("let presentedSheetPresentation: IPadWorkboardPresentedSheetPresentation?"))
        #expect(source.contains("func presentedSheetPresentation("))
        #expect(source.contains("presentedSheetPresentation: self.presentedSheetPresentation(gatewayAccess: gatewayAccess)"))
        #expect(source.contains("get: { self.screenPresentation.presentedSheetPresentation }"))
        #expect(!source.contains("self.store.state.cardDetailSheetPresentation("))
        ...
        #expect(source.contains("self.compactWriteUnavailableMessage(canRead: canRead)"))
        #expect(!source.contains("cardCreationPhase: self.store.cardCreationPhase"))
        #expect(!source.contains("trimmedDraftTitle: self.store.trimmedDraftTitle"))
        #expect(source.contains("Enter a title to create a card."))
        #expect(source.contains("Card creation is already in progress."))
        #expect(source.contains("struct IPadWorkboardCreateSheetPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCreateSheetErrorPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardCreateCardPresentation: Equatable, Sendable"))
        #expect(source.contains("let errorMessage: IPadWorkboardCreateSheetErrorPresentation?"))
        #expect(source.contains(
            "func createCardPresentation(gatewayAccess: IPadWorkboardGatewayAccess) -> IPadWorkboardCreateCardPresentation"))
        #expect(source.contains("createCardPresentation: self.createCardPresentation(gatewayAccess: gatewayAccess)"))
        #expect(source.contains("buttonTitle: \"New Card\""))
        #expect(source.contains("buttonIconSystemName: \"plus\""))
        #expect(source.contains("buttonAccessibilityHint: \"Opens card title and notes entry\""))
        #expect(source.contains("isButtonDisabled: isCreating"))
        #expect(source.contains("sectionTitle: \"Card\""))
        #expect(source.contains("titleText: self.draftTitle.value"))
        #expect(source.contains("notesText: self.draftNotes.value"))
        #expect(source.contains("titlePlaceholder: \"Title\""))
        #expect(source.contains("notesPlaceholder: \"Notes\""))
        #expect(source.contains("errorMessage: self.errorText.map { .init(text: $0.value, tone: .warn) }"))
        #expect(source.contains("cancelTitle: \"Cancel\""))
        #expect(source.contains("confirmationTitle: isCreating ? \"Creating...\" : \"Create\""))
        #expect(source.contains("confirmationAccessibilityHint: self.createUnavailableMessage("))
        #expect(screenSource.contains("private var createCardPresentation: IPadWorkboardCreateCardPresentation"))
        #expect(screenSource.contains("self.screenPresentation.createCardPresentation"))
        #expect(!screenSource.contains("self.store.state.createCardPresentation("))
        #expect(!screenSource.contains("self.store.state.createCardPresentation(gatewayAccess: self.gatewayAccess)"))
        #expect(screenSource.contains("Label(\n                self.createCardPresentation.buttonTitle,"))
        #expect(screenSource.contains("systemImage: self.createCardPresentation.buttonIconSystemName"))
        #expect(screenSource.contains(".accessibilityHint(self.createCardPresentation.buttonAccessibilityHint)"))
        #expect(screenSource.contains("Section(self.createCardPresentation.sheet.sectionTitle)"))
        #expect(screenSource.contains("get: { self.createCardPresentation.sheet.titleText }"))
        #expect(screenSource.contains("get: { self.createCardPresentation.sheet.notesText }"))
        #expect(!screenSource.contains("get: { self.store.draftTitle.value }"))
        #expect(!screenSource.contains("get: { self.store.draftNotes.value }"))
        #expect(screenSource.contains("TextField(self.createCardPresentation.sheet.titlePlaceholder"))
        #expect(screenSource.contains("TextField(\n                    self.createCardPresentation.sheet.notesPlaceholder,"))
        #expect(screenSource.contains("if let errorMessage = self.createCardPresentation.sheet.errorMessage"))
        #expect(screenSource.contains("Text(errorMessage.text)"))
        #expect(screenSource.contains("Self.messageColor(for: errorMessage.tone)"))
        #expect(!createSheetSource.contains("if let errorText = self.store.errorText"))
        #expect(screenSource.contains(".navigationTitle(self.createCardPresentation.sheet.title)"))
        #expect(screenSource.contains("Button(self.createCardPresentation.sheet.cancelTitle)"))
        #expect(screenSource.contains("Text(self.createCardPresentation.sheet.confirmationTitle)"))
        #expect(screenSource.contains(".disabled(self.createCardPresentation.sheet.isConfirmationDisabled)"))
        #expect(screenSource
            .contains(".accessibilityHint(self.createCardPresentation.sheet.confirmationAccessibilityHint)"))
        ...
        #expect(source.contains(".disabled(self.createCardPresentation.isButtonDisabled)"))
        ...
        #expect(!source.contains("func createCardPresentation(canRead: Bool, canWrite: Bool)"))
        #expect(!screenSource.contains("createCardPresentation(\n            canRead: self.gatewayAccess.canRead"))
        #expect(!newCardButtonSource.contains("Label(\"New Card\", systemImage: \"plus\")"))
        #expect(!newCardButtonSource.contains(".accessibilityHint(\"Opens card title and notes entry\")"))
        #expect(!newCardButtonSource.contains(".disabled(self.store.cardCreationPhase == .inFlight)"))
        #expect(!createSheetSource.contains(
            ".accessibilityHint(self.createUnavailableMessage ?? \"Creates a workboard card\")"))
        #expect(!createSheetSource.contains("self.store.cardCreationPhase == .inFlight ? \"Creating...\" : \"Create\""))
        #expect(!createSheetSource.contains(".disabled(self.store.cardCreationPhase == .inFlight)"))
        #expect(!createSheetSource.contains("Section(\"Card\")"))
        #expect(!createSheetSource.contains("TextField(\"Title\""))
        #expect(!createSheetSource.contains("TextField(\"Notes\""))
        #expect(!createSheetSource.contains(".navigationTitle(\"New Card\")"))
        #expect(!createSheetSource.contains("Button(\"Cancel\")"))
        #expect(!screenSource.contains("private var createUnavailableMessage: String?"))
        #expect(createFunction.contains("gatewayAccess: self.gatewayAccess"))
        ...
        #expect(source.contains("State.normalizedScopeID(change.boardID.value)"))
        #expect(source.contains("self.store.send(.boardScopeChanged(.init(boardID: .init(value: option.id))))"))
        #expect(!source.contains("struct BoardScopeChange: Equatable, Sendable {\n            var boardID: String"))
        ...
        #expect(archiveFunction.contains("gatewayAccess: self.gatewayAccess"))
        #expect(!archiveFunction.contains("writeAccess: .init(canWrite: self.gatewayAccess.canWrite)"))
        ...
        #expect(source.contains("option.isSelected"))
        #expect(!source.contains("self.statusFilterControlPresentation.selectedFilter == option.id"))
        #expect(source.contains("get: { self.statusFilterControlPresentation.selectedFilter }"))
    ...
    @Test func `workboard card presentation is reducer owned`() throws {
        ...
        #expect(source.contains("struct IPadWorkboardChatSessionKey: Equatable, Sendable"))
        #expect(source.contains("var openChat: @Sendable @MainActor (IPadWorkboardChatSessionKey) -> Void"))
        #expect(source.contains("struct ChatSessionOpenRequest: Equatable, Sendable"))
        #expect(source.contains("case chatSessionOpened(ChatSessionOpenRequest)"))
        #expect(source.contains("await client.openChat(request.sessionKey)"))
        #expect(screenSource.contains("await self.store.send(.chatSessionOpened(.init(sessionKey: .init(value: sessionKey)))).finish()"))
        #expect(!screenSource.contains("self.appModel.openChat(sessionKey: sessionKey)"))
        #expect(source.contains("enum IPadWorkboardCardTone: Equatable, Sendable"))
        #expect(source.contains("let iconSystemName: String"))
        #expect(source.contains("let tone: IPadWorkboardCardTone"))
        #expect(source.contains("let labelsSummary: String?"))
        #expect(source.contains("let sessionKey: String?"))
        #expect(source.contains("let detailSheetTitle: String"))
        #expect(source.contains("let detailSectionTitle: String"))
        #expect(source.contains("let titleFieldTitle: String"))
        #expect(source.contains("let statusFieldTitle: String"))
        #expect(source.contains("let actionsSectionTitle: String"))
        #expect(source.contains("let doneActionTitle: String"))
        #expect(source.contains("var showsOpenSessionAction: Bool"))
        #expect(source.contains("struct IPadWorkboardKanbanCardPresentation: Equatable, Sendable"))
        #expect(source.contains("func cardPresentation(for card: IPadWorkboardCard) -> IPadWorkboardCardPresentation"))
        #expect(source.contains("func kanbanCardPresentation(for card: IPadWorkboardCard)"))
        #expect(!source.contains("func openSessionKey(for card: IPadWorkboardCard) -> String?"))
        ...
        #expect(source.contains("static func cardTone(for status: String) -> IPadWorkboardCardTone"))
        ...
        #expect(source.contains("tone: self.cardTone(for: card.status)"))
        ...
        #expect(screenSource.contains("private enum IPadWorkboardCardColor"))
        #expect(screenSource.contains("IPadWorkboardCardColor.value(for: self.presentation.cardPresentation.tone)"))
        #expect(screenSource.contains("presentation: item.rowPresentation"))
        #expect(!screenSource.contains("presentation: self.store.state.queueRowPresentation(for: card)"))
        #expect(!screenSource.contains("presentation: self.store.state.cardPresentation(for: card)"))
        #expect(screenSource.contains("presentation: item.cardPresentation"))
        #expect(!screenSource.contains("cardPresentation: { card in"))
        #expect(!screenSource.contains("self.store.state.kanbanCardPresentation(for: card)"))
        #expect(!screenSource.contains("presentation: IPadWorkboardFeature.State.cardPresentation(for: card)"))
        #expect(!screenSource.contains("self.store.state.openSessionKey(for: card)"))
        #expect(!screenSource.contains("self.store.state.cardPresentation(for: card).sessionKey"))
        #expect(kanbanCardSource.contains("let presentation: IPadWorkboardKanbanCardPresentation"))
        #expect(kanbanCardSource.contains("ProIconBadge(systemName: self.presentation.cardPresentation.iconSystemName"))
        #expect(kanbanCardSource.contains("Text(self.presentation.cardPresentation.title)"))
        #expect(kanbanCardSource.contains("Text(self.presentation.cardPresentation.detail)"))
        #expect(kanbanCardSource.contains("if let labelsSummary = self.presentation.cardPresentation.labelsSummary"))
        #expect(kanbanCardSource.contains("if let sessionKey = self.presentation.cardPresentation.sessionKey"))
        #expect(kanbanCardSource.contains("self.openSession(sessionKey)"))
        ...
        #expect(kanbanCardSource.contains("ProValuePill(value: self.presentation.cardPresentation.statusLabel"))
        #expect(queueRowSource.contains("let presentation: IPadWorkboardQueueRowPresentation"))
        #expect(queueRowSource.contains("ProIconBadge(systemName: self.presentation.cardPresentation.iconSystemName"))
        #expect(queueRowSource.contains("Text(self.presentation.cardPresentation.title)"))
        #expect(queueRowSource.contains("Text(self.presentation.cardPresentation.detail)"))
        #expect(queueRowSource.contains("Button(self.presentation.cardPresentation.inspectActionTitle"))
        #expect(queueRowSource.contains("Button(self.presentation.cardPresentation.compactOpenSessionActionTitle"))
        #expect(queueRowSource.contains("Button(self.presentation.cardPresentation.openSessionActionTitle"))
        #expect(queueRowSource.contains("if let sessionKey = self.presentation.cardPresentation.sessionKey"))
        #expect(queueRowSource.contains("self.openSession(sessionKey)"))
        #expect(queueRowSource.contains("Button(self.presentation.cardPresentation.archiveActionTitle"))
        #expect(detailSheetSource.contains("let presentation: IPadWorkboardCardDetailSheetPresentation"))
        #expect(detailSheetSource.contains("Section(self.presentation.cardPresentation.detailSectionTitle)"))
        #expect(detailSheetSource.contains("LabeledContent(\n                        self.presentation.cardPresentation.titleFieldTitle"))
        #expect(detailSheetSource.contains("self.presentation.cardPresentation.statusFieldTitle"))
        #expect(detailSheetSource.contains("Section(self.presentation.cardPresentation.actionsSectionTitle)"))
        #expect(detailSheetSource.contains(".navigationTitle(self.presentation.cardPresentation.detailSheetTitle)"))
        #expect(detailSheetSource.contains("Button(self.presentation.cardPresentation.doneActionTitle)"))
        #expect(detailSheetSource.contains("if let notes = self.presentation.cardPresentation.notesText"))
        #expect(detailSheetSource.contains("if let sessionKey = self.presentation.cardPresentation.sessionKey"))
        #expect(detailSheetSource.contains("self.openSession(sessionKey)"))
        #expect(detailSheetSource.contains("Menu(self.presentation.cardPresentation.moveMenuTitle)"))
        #expect(!detailSheetSource.contains("Section(\"Card\")"))
        #expect(!detailSheetSource.contains("Section(\"Actions\")"))
        #expect(!detailSheetSource.contains("LabeledContent(\"Title\""))
        #expect(!detailSheetSource.contains("LabeledContent(\"Status\""))
        #expect(!detailSheetSource.contains(".navigationTitle(\"Card\")"))
        #expect(!detailSheetSource.contains("Button(\"Done\")"))
        ...
        #expect(!kanbanCardSource.contains("switch self.card.status"))
        #expect(!queueRowSource.contains("private var icon: String"))
        #expect(!queueRowSource.contains("private var detail: String"))
        #expect(!queueRowSource.contains("switch self.card.status"))
    }
    ...
    @Test func `workboard move action presentation is reducer owned`() throws {
        ...
        #expect(source.contains("var moveActionPresentations: [IPadWorkboardMoveActionPresentation]"))
        #expect(source.contains("Self.moveActionPresentations(for: self.statusValues)"))
        #expect(source.contains("func nextMoveActionPresentation(for card: IPadWorkboardCard)"))
        #expect(source.contains("Self.nextMoveActionPresentation(for: card, statuses: self.statusValues)"))
        #expect(source.contains("struct IPadWorkboardQueueRowPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadWorkboardKanbanCardPresentation: Equatable, Sendable"))
        #expect(source.contains("func queueRowPresentation(for card: IPadWorkboardCard)"))
        #expect(source.contains("func kanbanCardPresentation(for card: IPadWorkboardCard)"))
        #expect(!source.contains("\n        func moveActionPresentations(for statuses: [String])"))
        ...
        #expect(!screenSource.contains("cardPresentation: { card in"))
        #expect(!screenSource.contains("self.store.state.kanbanCardPresentation(for: card)"))
        #expect(!screenSource.contains("moveActions: self.store.moveActionPresentations"))
        #expect(screenSource.contains("presentation: item.rowPresentation"))
        #expect(!screenSource.contains("presentation: self.store.state.queueRowPresentation(for: card)"))
        #expect(!screenSource.contains("nextMoveAction: self.store.state.nextMoveActionPresentation(for: card)"))
        #expect(!screenSource.contains(
            "moveActions: self.store.state.moveActionPresentations(for: self.store.statusValues)"))
        #expect(!screenSource.contains("statuses: self.store.statusValues"))
        #expect(kanbanCardSource.contains("let presentation: IPadWorkboardKanbanCardPresentation"))
        #expect(kanbanCardSource.contains("ForEach(self.presentation.moveActions)"))
        #expect(kanbanCardSource.contains("Button(action.menuTitle)"))
        #expect(kanbanCardSource.contains("self.move(action.status)"))
        #expect(queueRowSource.contains("let presentation: IPadWorkboardQueueRowPresentation"))
        #expect(queueRowSource.contains("ForEach(self.presentation.moveActions)"))
        #expect(queueRowSource.contains("if let nextMoveAction = self.presentation.nextMoveAction"))
        #expect(queueRowSource.contains("Button(nextMoveAction.title)"))
        #expect(queueRowSource.contains("Button(action.menuTitle)"))
        #expect(detailSheetSource.contains("let presentation: IPadWorkboardCardDetailSheetPresentation"))
        #expect(detailSheetSource.contains("ForEach(self.presentation.moveActions)"))
    ...
    @Test func `workboard status message presentation is reducer owned`() throws {
        ...
        #expect(source.contains("statusMessagePresentations: self.statusMessagePresentations"))
        #expect(screenSource.contains("ForEach(self.screenPresentation.statusMessagePresentations)"))
        #expect(!screenSource.contains("ForEach(self.store.statusMessagePresentations)"))
        #expect(screenSource.contains("Self.messageColor(for: message.tone)"))
    ...
    @Test func `workboard card action control presentation is reducer owned`() throws {
        ...
        #expect(source.contains("self.cardActionControlPresentation(for: card, context: .kanban)"))
        #expect(screenSource.contains("presentation: item.cardPresentation"))
        #expect(!kanbanBoardSource.contains("self.store.state.kanbanCardPresentation(for: card)"))
        #expect(!kanbanBoardSource.contains("context: .kanban"))
        #expect(source.contains("self.cardActionControlPresentation(for: card, context: .queue)"))
        #expect(!compactCardsSource.contains("context: .queue"))
        #expect(!compactCardsSource.contains("queueRowPresentation(for: card)"))
        #expect(kanbanCardSource.contains("let presentation: IPadWorkboardKanbanCardPresentation"))
        #expect(kanbanCardSource.contains(
        ...
        #expect(kanbanCardSource.contains(".disabled(self.presentation.actionControlPresentation.isDisabled)"))
        ...
        #expect(queueRowSource.contains(
            ".accessibilityLabel(self.presentation.actionControlPresentation.accessibilityLabel)"))
        #expect(queueRowSource.contains(".disabled(self.presentation.actionControlPresentation.isDisabled)"))
    ...
    @Test func `workboard card detail action controls presentation is reducer owned`() throws {
        ...
        #expect(source.contains("func cardDetailSheetPresentation("))
        #expect(source.contains("func presentedSheetPresentation("))
        #expect(source.contains("let presentedSheetPresentation: IPadWorkboardPresentedSheetPresentation?"))
        ...
        #expect(source.contains("presentedSheetPresentation: self.presentedSheetPresentation(gatewayAccess: gatewayAccess)"))
        #expect(screenSource.contains("private var presentedSheetBinding: Binding<IPadWorkboardPresentedSheetPresentation?>"))
        #expect(screenSource.contains("get: { self.screenPresentation.presentedSheetPresentation }"))
        #expect(screenSource.contains("presentation: presentation.sheetPresentation"))
        #expect(screenSource.contains("Task { @MainActor in await self.open(sessionKey: sessionKey) }"))
        #expect(!screenSource.contains("self.store.state.cardDetailSheetPresentation("))
        ...
        #expect(detailSheetSource.contains(".disabled(self.presentation.actionControlsPresentation.isMutationDisabled)"))
    ...
    @Test func `workboard kanban lane presentation is reducer owned`() throws {
        ...
        #expect(source.contains("struct IPadWorkboardKanbanCardItemPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("struct IPadWorkboardKanbanColumnPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("let emptyState: IPadWorkboardKanbanLaneEmptyStatePresentation"))
        #expect(source.contains("let cardItemPresentations: [IPadWorkboardKanbanCardItemPresentation]"))
        #expect(source.contains(
        ...
        #expect(source.contains("kanbanColumnPresentations: self.kanbanColumnPresentations"))
        #expect(kanbanBoardSource.contains("ForEach(self.screenPresentation.kanbanColumnPresentations)"))
        #expect(!kanbanBoardSource.contains("ForEach(self.store.kanbanColumnPresentations)"))
        ...
        #expect(source.contains("cardItemPresentations: cards.map { card in"))
        #expect(kanbanColumnSource.contains("let presentation: IPadWorkboardKanbanColumnPresentation"))
        #expect(kanbanColumnSource.contains("title: self.presentation.lanePresentation.title"))
        #expect(kanbanColumnSource.contains("value: self.presentation.lanePresentation.value"))
        #expect(kanbanColumnSource.contains("icon: self.presentation.lanePresentation.emptyState.icon"))
        #expect(kanbanColumnSource.contains("title: self.presentation.lanePresentation.emptyState.title"))
        #expect(kanbanColumnSource.contains("detail: self.presentation.lanePresentation.emptyState.detail"))
        #expect(kanbanColumnSource.contains("value: self.presentation.lanePresentation.emptyState.value"))
        #expect(kanbanColumnSource.contains("Array(self.presentation.cardItemPresentations.enumerated())"))
        #expect(kanbanColumnSource.contains("presentation: item.cardPresentation"))
        #expect(!kanbanColumnSource.contains("Array(self.presentation.cards.enumerated())"))
    ...
    @Test func `compact task rows keep phone native actions`() throws {
        ...
        #expect(source.contains("self.store.send(.cardSheetPresented(.init(card: item.card)))"))
        #expect(source.contains("self.open(sessionKey: sessionKey)"))
        #expect(!source.contains("self.open(item.card)"))
        #expect(source.contains("Task { await self.move(item.card, to: status) }"))
        #expect(source.contains("Task { await self.archive(item.card) }"))
    ...
    @Test func `skill workshop uses kanban lanes on wide I pad`() throws {
        ...
        let kanbanCard = try Self.extract(
            ...
            to: "struct IPadSkillProposalRow")
        ...
        #expect(board.contains("actionControlsPresentation: actionControlsPresentation"))
        #expect(board.contains("inspectionControlsPresentation: inspectionControlsPresentation"))
        ...
        #expect(typeSource.contains("enum IPadSkillWorkshopFeedbackTone: Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillWorkshopFeedbackPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("var feedbackMessages: [IPadSkillWorkshopFeedbackPresentation]"))
        #expect(source.contains("messages.append(.init(tone: .notice, text: noticeText.value))"))
        #expect(source.contains("messages.append(.init(tone: .error, text: errorText.value))"))
        #expect(source.contains("private var feedbackMessageRows: some View"))
        #expect(source.contains("feedbackMessages: self.feedbackMessages"))
        #expect(source.contains("ForEach(self.screenPresentation.feedbackMessages)"))
        #expect(source.contains("Text(message.text)"))
        #expect(source.contains(".foregroundStyle(message.color)"))
        #expect(!source.contains("ForEach(self.store.feedbackMessages)"))
        #expect(!source.contains("if let noticeText = self.store.noticeText"))
        #expect(!source.contains("if let errorText = self.store.errorText"))
        ...
        #expect(source.contains("var isRefreshInFlight: Bool"))
        #expect(source.contains("self.loadingPhase == .inFlight"))
        #expect(typeSource.contains("struct IPadSkillWorkshopRefreshControlPresentation: Equatable, Sendable"))
        #expect(typeSource.contains("let title: String"))
        #expect(typeSource.contains("let iconSystemName: String"))
        #expect(source.contains("var refreshControlPresentation: IPadSkillWorkshopRefreshControlPresentation"))
        #expect(source.contains("title: \"Refresh\""))
        #expect(source.contains("iconSystemName: \"arrow.clockwise\""))
        #expect(source.contains("refreshControlPresentation: self.refreshControlPresentation"))
        #expect(source.contains("self.screenPresentation.refreshControlPresentation"))
        #expect(source.contains("let refreshPresentation = self.screenPresentation.refreshControlPresentation"))
        #expect(source.contains("Label(refreshPresentation.title, systemImage: refreshPresentation.iconSystemName)"))
        #expect(source.contains(".disabled(refreshPresentation.isDisabled)"))
        #expect(source.contains("if refreshPresentation.showsProgress"))
        #expect(!source.contains("let refreshPresentation = self.store.refreshControlPresentation"))
        #expect(source.contains("guard !state.isRefreshInFlight else { return .none }"))
        #expect(source.contains("state.loadingPhase = .inFlight"))
        #expect(source.contains("state.loadingPhase = .idle"))
        #expect(!source.contains(".disabled(self.store.isRefreshInFlight)"))
        #expect(!source.contains("if self.store.isRefreshInFlight"))
        ...
        #expect(typeSource.contains("struct IPadSkillProposalSheetRoute: Equatable, Identifiable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalAction: Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalManifest: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalManifestEntry: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalInspectResponse: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalRecord: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalTarget: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposalSupportFile: Decodable, Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillProposal: Equatable, Identifiable, Sendable"))
        #expect(typeSource.contains("var ageLabel: String"))
        #expect(source.contains("extension IPadSkillProposal"))
        #expect(source.contains("var statusColor: Color"))
        #expect(!source.contains("struct IPadSkillProposalManifest: Decodable, Equatable, Sendable"))
        #expect(!source.contains("struct IPadSkillProposal: Equatable, Identifiable, Sendable"))
        #expect(!source.contains("private static func parseDate(_ value: String) -> Double"))
        #expect(!source.contains("private static func stripFrontmatter(_ value: String) -> String"))
        ...
        #expect(source.contains("var filteredProposals: [IPadSkillProposal]"))
        #expect(source.contains("var filteredProposalCount: Int"))
        #expect(typeSource.contains("struct IPadSkillWorkshopQueueSummaryPresentation: Equatable, Sendable"))
        #expect(typeSource.contains("let title: String"))
        #expect(source.contains("var queueSummaryPresentation: IPadSkillWorkshopQueueSummaryPresentation"))
        #expect(source.contains("title: \"Queue\""))
        #expect(source.contains("proposalCount: self.filteredProposalCount"))
        #expect(source.contains("value: \"\\(self.filteredProposalCount)\""))
        #expect(source.contains("proposalCountLabel: \"\\(self.filteredProposalCount) proposals\""))
        #expect(source.contains("statusLabel: self.statusFilterLabel"))
        #expect(source.contains("queueSummaryPresentation: self.queueSummaryPresentation"))
        #expect(source.contains("var pendingProposalCount: Int"))
        #expect(source.contains("var appliedProposalCount: Int"))
        #expect(source.contains("var heldProposalCount: Int"))
        #expect(typeSource.contains("enum IPadSkillWorkshopMetricTone: Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillWorkshopMetricPresentation: Equatable, Identifiable, Sendable"))
        #expect(source.contains("var metricPresentations: [IPadSkillWorkshopMetricPresentation]"))
        #expect(source.contains("value: \"\\(self.pendingProposalCount)\""))
        #expect(source.contains("value: \"\\(self.appliedProposalCount)\""))
        #expect(source.contains("value: \"\\(self.heldProposalCount)\""))
        #expect(source.contains("metricPresentations: self.metricPresentations"))
        #expect(source.contains("self.screenPresentation.metricPresentations.map { presentation in"))
        #expect(!source.contains("self.store.metricPresentations.map { presentation in"))
        #expect(source.contains("color: presentation.id.color"))
        #expect(source.contains("var visibleProposalLaneStatuses: [String]"))
        #expect(source.contains("func proposals(forLaneStatus status: String) -> [IPadSkillProposal]"))
        ...
        #expect(source.contains("func proposalCardPresentation("))
        #expect(source.contains(
        ...
        #expect(source.contains("proposalBoardPresentation: self.proposalBoardPresentation"))
        #expect(source.contains("let boardPresentation = self.screenPresentation.proposalBoardPresentation"))
        #expect(!source.contains("self.store.proposalBoardPresentation"))
        #expect(source.contains("ForEach(boardPresentation.lanes) { lane in"))
        #expect(source.contains("lane: lane"))
        #expect(source.contains("value: self.lane.value"))
        ...
        #expect(source.contains("value: queueSummary.value"))
        #expect(source.contains("queueSummary.statusLabel"))
        #expect(!source.contains("self.store.queueSummaryPresentation"))
        #expect(!proposalList.contains("value: \"\\(queueSummary.proposalCount)\""))
        #expect(!source.contains("Text(\"\\(queueSummary.proposalCount) proposals\")"))
        #expect(!proposalList.contains("title: \"Queue\""))
        #expect(!source.contains("self.store.filteredProposalCount"))
        #expect(!source.contains("self.store.filteredProposals"))
        #expect(!source.contains("self.store.filteredProposals.count"))
        #expect(!source.contains("value: \"\\(self.store.pendingProposalCount)\""))
        #expect(!source.contains("value: \"\\(self.store.appliedProposalCount)\""))
        #expect(!source.contains("value: \"\\(self.store.heldProposalCount)\""))
        #expect(!source.contains("self.store.visibleProposalLaneStatuses"))
        ...
        #expect(source.contains("ProIconBadge(systemName: card.iconSystemName"))
        #expect(source.contains("if let bodyText = presentation.bodyText"))
        #expect(source.contains("Text(presentation.emptyBodyText)"))
        #expect(typeSource.contains("let supportFilesTitle: String"))
        #expect(source.contains("supportFilesTitle: \"Support files\""))
        #expect(source.contains("if presentation.showsSupportFiles"))
        #expect(source.contains("Text(presentation.supportFilesTitle)"))
        ...
        #expect(!source.contains("Text(\"Support files\")"))
        #expect(!source.contains("ProIconBadge(systemName: \"hammer\", color: proposal.statusColor)"))
        ...
        #expect(!source.contains("self.store.proposals.first { $0.id == id }"))
        #expect(!source.contains("self.store.proposals.count(where: { $0.status == status })"))
        #expect(!source.contains("self.count(\"pending\")"))
        #expect(!source.contains("self.count(\"applied\")"))
        #expect(!source.contains("self.count(\"quarantined\") + self.count(\"stale\")"))
        #expect(!source.contains("private var visibleProposalLaneStatuses: [String]"))
        #expect(!source.contains("private func proposals(forLaneStatus status: String) -> [IPadSkillProposal]"))
        #expect(!source.contains("let trimmedQuery = self.store.query.value.trimmingCharacters"))
        #expect(source.contains("state.proposalEntries = .init(values: proposalValues)"))
        #expect(!source.contains("var proposals: [IPadSkillProposal] = []"))
        #expect(!source.contains("state.proposals = []"))
        #expect(!source.contains("state.proposals = manifest.proposals"))
        ...
        #expect(source.contains("isSelected: proposal.id == self.selectedProposalID?.value"))
        #expect(source.contains("let proposal = presentation.proposal"))
        #expect(!source.contains("func proposalPresentation(for proposal: IPadSkillProposal)"))
        #expect(!source.contains("struct IPadSkillProposalPresentation: Equatable, Sendable"))
        #expect(!source.contains("let presentation = self.proposalPresentation(for: proposal)"))
        ...
        #expect(typeSource.contains("let title: String"))
        #expect(typeSource.contains("let iconSystemName: String"))
        #expect(typeSource.contains("let accessibilityLabel: String"))
        #expect(source.contains(
        ...
        #expect(source.contains("accessibilityLabel: \"Inspect Proposal\""))
        ...
        #expect(kanbanCard.contains("Image(systemName: self.inspectionControlsPresentation.iconSystemName)"))
        #expect(kanbanCard.contains(".accessibilityLabel(self.inspectionControlsPresentation.accessibilityLabel)"))
        #expect(kanbanCard.contains("Button(self.inspectionControlsPresentation.title, action: self.inspect)"))
        #expect(!kanbanCard.contains("Image(systemName: \"doc.text.magnifyingglass\")"))
        #expect(!kanbanCard.contains(".accessibilityLabel(\"Inspect Proposal\")"))
        #expect(!kanbanCard.contains("Button(\"Inspect\""))
        ...
        #expect(!source.contains("isInspecting: proposal.id == self.inspectingProposalID,"))
        #expect(!source.contains(".disabled(self.store.inspectingProposalID != nil)"))
        ...
        #expect(typeSource.contains("struct IPadSkillWorkshopScreenPresentation: Equatable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillWorkshopAgentScopeOption: Equatable, Identifiable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillWorkshopAgentScopeMenuPresentation: Equatable, Sendable"))
        ...
        #expect(source.contains("static func normalizedScopeID(_ value: String?) -> String"))
        #expect(source.contains("var gatewayAgents: [IPadSkillWorkshopGatewayAgent]"))
        #expect(source.contains("var agentScopeOptions: [IPadSkillWorkshopAgentScopeOption]"))
        #expect(source.contains("var agentScopeLabel: String"))
        #expect(source.contains("var defaultAgentScopeLabel: String"))
        #expect(source.contains("var agentScopeMenuPresentation: IPadSkillWorkshopAgentScopeMenuPresentation"))
        #expect(source.contains("title: \"Agent\""))
        #expect(source.contains("selectedLabel: self.agentScopeLabel"))
        #expect(source.contains("selectorIconSystemName: \"chevron.up.chevron.down\""))
        #expect(source.contains("accessibilityLabel: \"Skill Workshop agent scope\""))
        #expect(source.contains("isEnabled: !options.isEmpty"))
        #expect(source.contains("agentScopeMenuPresentation: self.agentScopeMenuPresentation"))
        #expect(source.contains("let presentation = self.screenPresentation.agentScopeMenuPresentation"))
        #expect(source.contains("Text(presentation.title)"))
        #expect(source.contains("ForEach(presentation.options, id: \\.id)"))
        #expect(source.contains("Text(presentation.selectedLabel)"))
        #expect(source.contains("Image(systemName: presentation.selectorIconSystemName)"))
        ...
        #expect(!source.contains("let presentation = self.store.agentScopeMenuPresentation"))
        #expect(!source.contains("Text(\"Agent\")"))
        #expect(!source.contains("Image(systemName: \"chevron.up.chevron.down\")"))
        #expect(!source.contains(".accessibilityLabel(\"Skill Workshop agent scope\")"))
        #expect(!source.contains("Button(\"Default agent\")"))
        #expect(!source.contains("var agentScopeMenuOptions: [IPadSkillWorkshopAgentScopeOption]"))
        #expect(!source.contains("var shouldEnableAgentScopeMenu: Bool"))
        #expect(!source.contains("self.store.agentScopeMenuOptions"))
        #expect(!source.contains("Text(self.store.agentScopeLabel)"))
        #expect(!source.contains(".disabled(!self.store.shouldEnableAgentScopeMenu)"))
        #expect(!source.contains("self.store.agentScopeOptions"))
        #expect(!source.contains(".disabled(self.store.agentScopeOptions.isEmpty)"))
        #expect(source.contains("static func gatewayAccess("))
        #expect(source.contains("isAppleReviewDemoModeEnabled: Bool"))
        #expect(source.contains("canWrite: isOperatorGatewayConnected && !isAppleReviewDemoModeEnabled"))
        #expect(source.contains(
        ...
        #expect(source.contains("func screenPresentation("))
        #expect(source.contains("private var screenPresentation: IPadSkillWorkshopScreenPresentation"))
        #expect(source.contains("self.store.state.screenPresentation("))
        #expect(typeSource.contains("struct IPadSkillWorkshopScreenChromePresentation: Equatable, Sendable"))
        #expect(typeSource.contains("let subtitle: String"))
        #expect(source.contains("var screenChromePresentation: IPadSkillWorkshopScreenChromePresentation"))
        #expect(source.contains("screenChromePresentation: self.screenChromePresentation"))
        #expect(source.contains("title: self.screenPresentation.screenChromePresentation.title"))
        #expect(source.contains("subtitle: self.screenPresentation.screenChromePresentation.subtitle"))
        #expect(!source.contains("IPadSidebarScreenChrome(\n            title: \"Skill Workshop\""))
        #expect(!source.contains("subtitle: \"Review and apply proposed skills.\","))
        #expect(source.contains(".task(id: self.refreshTaskID)"))
        #expect(source.contains("self.screenPresentation.refreshTaskID"))
        ...
        #expect(source.contains("accessibilityLabel: \"Apply Proposal\""))
        ...
        #expect(source.contains("accessibilityLabel: \"Reject Proposal\""))
        #expect(source.contains(
        ...
        #expect(kanbanCard.contains("Button(self.actionControlsPresentation.applyButton.title, action: self.apply)"))
        #expect(kanbanCard.contains(
        ...
        #expect(!kanbanCard.contains("Button(\"Reject\""))
        ...
        #expect(!source.contains("private var agentScopeLabel: String"))
        ...
        #expect(typeSource.contains("struct IPadSkillWorkshopStatusFilterOption: Equatable, Identifiable, Sendable"))
        #expect(typeSource.contains("struct IPadSkillWorkshopStatusFilterControlPresentation: Equatable, Sendable"))
        ...
        #expect(source.contains("static func proposalStatusFilterLabel(_ filter: String) -> String"))
        #expect(source.contains("static func proposalLaneLabel(_ status: String) -> String"))
        #expect(source.contains("private static func titleCasedProposalStatus(_ status: String) -> String"))
        #expect(source.contains("static func proposalStatusMatchesFilter(status: String, filter: String) -> Bool"))
        #expect(source.contains("static func proposalStatusBoardLanes(filter: String, proposalStatuses: [String]) -> [String]"))
        #expect(source.contains("static func nextSelectedProposalID("))
        #expect(source.contains("static func shouldShowProposalActions(status: String) -> Bool"))
        #expect(source.contains("func shouldShowProposalActions(for proposal: IPadSkillProposal) -> Bool"))
        #expect(source.contains("Self.proposalStatusFilterLabel(self.statusFilter.value)"))
        #expect(source.contains("Self.proposalStatusMatchesFilter("))
        #expect(source.contains("Self.proposalStatusBoardLanes("))
        ...
        #expect(typeSource.contains("let showsProposalActions: Bool"))
        #expect(source.contains(
        ...
        #expect(source.contains("if presentation.showsProposalActions"))
        #expect(source.contains("if self.presentation.showsProposalActions"))
        #expect(source.contains(".disabled(!self.actionControlsPresentation.canRunActions)"))
        #expect(source.contains("let nextID = Self.nextSelectedProposalID("))
        #expect(source.contains("selectedFilter: self.statusFilter.value"))
        ...
        #expect(source.contains("self.proposalStatusFilterLabel(status)"))
        #expect(source.contains("let title = Self.proposalLaneLabel(status)"))
        #expect(source.contains("title: title"))
        #expect(!source.contains("IPadSkillWorkshopFeature.State.proposalLaneLabel(self.status)"))
        #expect(source.contains("Self.proposalStatusMatchesFilter(status: $0.status, filter: filter)"))
        #expect(!source.contains("if proposal.status == \"pending\""))
        #expect(!source.contains("if self.proposal.status == \"pending\""))
        #expect(!source.contains("nonisolated static let proposalStatusFilters"))
        #expect(!source.contains("nonisolated static let defaultProposalStatusBoardLanes"))
        #expect(!source.contains("nonisolated static func proposalStatusFilterLabel"))
        #expect(!source.contains("nonisolated static func proposalLaneLabel"))
        #expect(!source.contains("nonisolated static func titleCasedProposalStatus"))
        #expect(!source.contains("nonisolated static func proposalStatusMatchesFilter"))
        #expect(!source.contains("nonisolated static func proposalStatusBoardLanes"))
        #expect(!source.contains("nonisolated static func nextSelectedProposalID"))
        #expect(!source.contains("nonisolated static func shouldShowProposalActions"))
        #expect(!source.contains("IPadSkillWorkshopScreen.nextSelectedProposalID("))
        ...
        #expect(source.contains("state.query = change.query"))
        #expect(source.contains("state.query = .init(value: \"\")"))
        #expect(typeSource.contains("struct IPadSkillWorkshopQueryFieldPresentation: Equatable, Sendable"))
        #expect(source.contains("var queryFieldPresentation: IPadSkillWorkshopQueryFieldPresentation"))
        #expect(source.contains("text: self.query.value"))
        #expect(source.contains("placeholder: \"Search proposals\""))
        #expect(source.contains("iconSystemName: \"magnifyingglass\""))
        #expect(source.contains("clearButtonSystemName: \"xmark.circle.fill\""))
        #expect(source.contains("showsClearButton: !self.query.value.isEmpty"))
        #expect(source.contains("queryFieldPresentation: self.queryFieldPresentation"))
        ...
        #expect(!source.contains("let presentation = self.store.queryFieldPresentation"))
        #expect(!source.contains("get: { self.store.queryFieldPresentation.text }"))
        #expect(!source.contains("TextField(\"Search proposals\", text: self.queryBinding)"))
        #expect(!source.contains("Image(systemName: \"magnifyingglass\")"))
        #expect(!source.contains("Image(systemName: \"xmark.circle.fill\")"))
        #expect(!source.contains("get: { self.store.query.value }"))
        ...
        #expect(source.contains("struct AgentScopeSnapshot: Equatable, Sendable"))
        #expect(source.contains("case agentScopeSnapshotChanged(AgentScopeSnapshot)"))
        #expect(source.contains("state.gatewayDefaultAgentID = snapshot.gatewayDefaultAgentID"))
        #expect(source.contains("state.gatewayAgentEntries = snapshot.gatewayAgents"))
        #expect(source.contains("state.activeAgentName = snapshot.activeAgentName"))
        ...
        #expect(source.contains(".task(id: self.agentScopeSnapshot)"))
        #expect(source.contains("self.store.send(.agentScopeSnapshotChanged(self.agentScopeSnapshot))"))
        ...
        #expect(previewSource.contains("actionControlsPresentation: self.actionControlsPresentation"))
        #expect(previewSource.contains("inspectionControlsPresentation: self.inspectionControlsPresentation"))
    ...
    @Test func `activity sessions refresh response action is typed`() throws {
        ...
        #expect(source.contains("struct IPadActivitySessionsMode: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivitySessionReferenceKey: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivityShareEventText: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivityPendingApprovalSnapshot: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivityPendingApprovalCommandText: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivityPendingApprovalCommandPreview: Equatable, Sendable"))
        ...
        #expect(feature.contains("var currentSession = IPadActivitySessionReferenceKey(value: \"\")"))
        #expect(feature.contains("var defaultSession = IPadActivitySessionReferenceKey(value: \"\")"))
        #expect(feature.contains("var sessions: [OpenClawChatSessionEntry] {"))
        #expect(feature.contains("sessionEntries.entries"))
        #expect(feature.contains("var visibleSessions: [OpenClawChatSessionEntry] {"))
        #expect(feature.contains("defaultSessionKey: self.defaultSession.value"))
        #expect(feature.contains(".sorted { ($0.updatedAt ?? 0) > ($1.updatedAt ?? 0) }"))
        #expect(feature.contains(".prefix(8)"))
        #expect(source.contains("struct IPadActivityScreenPresentation: Equatable, Sendable"))
        #expect(source.contains("struct IPadActivityScreenChromePresentation: Equatable, Sendable"))
        #expect(source.contains("let screenChromePresentation: IPadActivityScreenChromePresentation"))
        #expect(source.contains("struct IPadActivityFeedHeaderPresentation: Equatable, Sendable"))
        #expect(source.contains("let feedHeaderPresentation: IPadActivityFeedHeaderPresentation"))
        #expect(source.contains("struct IPadActivityMetricPresentation: Equatable, Sendable"))
        #expect(source.contains("let metricPresentations: [IPadActivityMetricPresentation]"))
        #expect(source.contains("struct IPadActivitySessionStatusPresentation: Equatable, Sendable"))
        #expect(source.contains("let loadingSessionsPresentation: IPadActivitySessionStatusPresentation"))
        #expect(source.contains("let unavailableSessionsPresentation: IPadActivitySessionStatusPresentation?"))
        ...
        #expect(commandCenterSource.contains("nonisolated static func sessionWorkItem("))
        #expect(source.contains("let sessionRows: [CommandCenterTab.WorkItem]"))
        #expect(source.contains("struct IPadActivityEmptySessionPresentation: Equatable, Sendable"))
        #expect(source.contains("let emptySessionPresentation: IPadActivityEmptySessionPresentation"))
        #expect(source.contains("struct IPadActivityShareIntakePresentation: Equatable, Sendable"))
        #expect(source.contains("let shareIntakePresentation: IPadActivityShareIntakePresentation"))
        #expect(source.contains("struct IPadActivityPendingApprovalPresentation: Equatable, Sendable"))
        #expect(source.contains("let pendingApprovalPresentation: IPadActivityPendingApprovalPresentation?"))
        #expect(feature.contains("func emptySessionPresentation("))
        #expect(feature.contains("sessionsAvailability: IPadActivitySessionsAvailable"))
        #expect(feature.contains("sessionsMode: IPadActivitySessionsMode"))
        #expect(feature.contains("lastShareEventText: IPadActivityShareEventText"))
        #expect(feature.contains("pendingApproval: IPadActivityPendingApprovalSnapshot?"))
        #expect(feature.contains("func refreshTaskID("))
        #expect(feature.contains("sceneActivity.value ? \"active\" : \"inactive\""))
        #expect(feature.contains("func shareIntakePresentation("))
        #expect(feature.contains("func pendingApprovalPresentation("))
        #expect(feature.contains("pendingApproval.commandPreview.value ?? pendingApproval.commandText.value"))
        #expect(feature.contains("var loadingSessionsPresentation: IPadActivitySessionStatusPresentation"))
        #expect(feature.contains("var unavailableSessionsPresentation: IPadActivitySessionStatusPresentation?"))
        #expect(feature.contains("loadingSessionsPresentation: self.loadingSessionsPresentation"))
        #expect(feature.contains("unavailableSessionsPresentation: self.unavailableSessionsPresentation"))
        #expect(feature.contains("func metricPresentations(sessionMetricValue: String) -> [IPadActivityMetricPresentation]"))
        #expect(feature.contains("metricPresentations: self.metricPresentations(sessionMetricValue: sessionMetricValue)"))
        #expect(feature.contains("func screenPresentation("))
        #expect(feature.contains("var screenChromePresentation: IPadActivityScreenChromePresentation"))
        #expect(feature.contains("screenChromePresentation: self.screenChromePresentation"))
        #expect(feature.contains("var feedHeaderPresentation: IPadActivityFeedHeaderPresentation"))
        #expect(feature.contains("feedHeaderPresentation: self.feedHeaderPresentation"))
        #expect(feature.contains("gatewayPresentation: self.gatewayPresentation"))
        #expect(feature.contains("refreshTaskID: self.refreshTaskID("))
        ...
        #expect(feature.contains("emptySessionPresentation: self.emptySessionPresentation"))
        #expect(feature.contains("shareIntakePresentation: self.shareIntakePresentation"))
        #expect(feature.contains("pendingApprovalPresentation: self.pendingApprovalPresentation"))
        #expect(source.contains("private var screenPresentation: IPadActivityScreenPresentation"))
        #expect(source.contains("title: self.screenPresentation.screenChromePresentation.title"))
        #expect(source.contains("subtitle: self.screenPresentation.screenChromePresentation.subtitle"))
        #expect(!source.contains("title: \"Activity\",\n            subtitle: \"Live device and gateway activity.\""))
        #expect(source.contains("self.store.state.screenPresentation("))
        #expect(source.contains("sessionsMode: .init(value: self.sessionsMode)"))
        #expect(source.contains("currentSession: .init(value: self.appModel.chatSessionKey)"))
        #expect(source.contains("defaultSession: .init(value: self.appModel.defaultChatSessionKey)"))
        #expect(source.contains("sceneActivity: .init(value: self.scenePhase == .active)"))
        #expect(source.contains("lastShareEventText: .init(value: self.appModel.lastShareEventText)"))
        #expect(source.contains("pendingApproval: self.pendingApprovalSnapshot"))
        ...
        #expect(source.contains("icon: self.gatewayPresentation.metricIcon"))
        #expect(source.contains("detail: gatewayPresentation.gatewayDetailText"))
        #expect(!source.contains("self.store.gatewayPresentation."))
        #expect(!source.contains("let sessionMetricValue: String"))
        #expect(!source.contains("let feedHeaderValue: String?"))
        #expect(source.contains("let showsLoadingSessionsPlaceholder: Bool"))
        #expect(!source.contains("let loadErrorText: IPadActivitySessionsFailureMessage?"))
        #expect(feature.contains("let sessionMetricValue = self.loadingPhase == .inFlight ? \"...\""))
        #expect(feature.contains("value: self.loadingPhase == .inFlight ? \"Loading\" : nil"))
        #expect(feature.contains("showsLoadingSessionsPlaceholder: self.loadingPhase == .inFlight && self.sessions.isEmpty"))
        #expect(source.contains("self.screenPresentation.metricPresentations.map"))
        #expect(source.contains("value: $0.value"))
        #expect(!source.contains("value: self.screenPresentation.sessionMetricValue"))
        #expect(!source.contains("title: \"Gateway\",\n                value: gatewayPresentation.gatewayStateText"))
        #expect(source.contains("title: self.screenPresentation.feedHeaderPresentation.title"))
        #expect(source.contains("value: self.screenPresentation.feedHeaderPresentation.value"))
        #expect(source.contains("actionTitle: self.screenPresentation.feedHeaderPresentation.actionTitle"))
        ...
        #expect(source.contains("let presentation = self.screenPresentation.loadingSessionsPresentation"))
        #expect(source.contains("} else if let presentation = self.screenPresentation.unavailableSessionsPresentation"))
        #expect(source.contains("detail: presentation.detail"))
        #expect(!source.contains("detail: loadErrorText.value"))
        #expect(!source.contains("ProStatusRow(\n                        icon: \"hourglass\""))
        #expect(!source.contains("ProStatusRow(\n                        icon: \"exclamationmark.triangle.fill\""))
        #expect(source.contains("let shareIntakePresentation = self.screenPresentation.shareIntakePresentation"))
        #expect(source.contains("icon: shareIntakePresentation.icon"))
        #expect(source.contains("title: shareIntakePresentation.title"))
        #expect(source.contains("detail: shareIntakePresentation.detail"))
        #expect(source.contains("value: shareIntakePresentation.value"))
        #expect(!source.contains("detail: self.appModel.lastShareEventText"))
        #expect(source.contains("if let pendingApprovalPresentation = self.screenPresentation.pendingApprovalPresentation"))
        #expect(source.contains("icon: pendingApprovalPresentation.icon"))
        #expect(source.contains("detail: pendingApprovalPresentation.detail"))
        #expect(source.contains("private var pendingApprovalSnapshot: IPadActivityPendingApprovalSnapshot?"))
        #expect(source.contains("self.appModel.pendingExecApprovalPrompt.map"))
        #expect(!source.contains("if let pendingExecApprovalPrompt = self.appModel.pendingExecApprovalPrompt"))
        #expect(!source.contains("pendingExecApprovalPrompt.commandPreview ?? pendingExecApprovalPrompt.commandText"))
        ...
        #expect(source.contains("let presentation = self.screenPresentation.emptySessionPresentation"))
        #expect(source.contains("title: presentation.title"))
        #expect(source.contains("detail: presentation.detail"))
        #expect(source.contains("value: presentation.value"))
        #expect(source.contains("actionTitle: presentation.actionTitle"))
        #expect(source.contains("action: presentation.opensChat ? self.openChat : nil"))
        #expect(!source.contains("title: self.sessionsAvailable ? \"No recent sessions\""))
        #expect(!source.contains("value: self.sessionsAvailable ? \"empty\" : \"offline\""))
        #expect(!source.contains("actionTitle: self.sessionsAvailable ? \"Chat\" : nil"))
        ...
        #expect(!feature.contains("set { sessionEntries = .init(entries: newValue) }"))
        ...
        #expect(feature.contains("var key: IPadActivitySessionReferenceKey"))
        ...
        #expect(feature.contains("state.currentSession = request.currentSession.key"))
        #expect(feature.contains("state.defaultSession = request.defaultSession.key"))
        ...
        #expect(feature.contains("switch response.result"))
        #expect(feature.contains("state.sessionEntries = .init()"))
        #expect(feature.contains("state.sessionEntries = sessionEntries"))
        #expect(!feature.contains("var sessions: [OpenClawChatSessionEntry] = []"))
        ...
        #expect(!feature.contains("var sessionsMode: String"))
        ...
        #expect(!source.contains("self.store.sessions\n            .filter"))
        #expect(!source.contains("defaultSessionKey: self.appModel.defaultChatSessionKey"))
        #expect(!source.contains("currentSessionKey: self.appModel.chatSessionKey"))
        #expect(!source.contains("currentSession: .init(key: self.appModel.chatSessionKey)"))
        #expect(!source.contains("defaultSession: .init(key: self.appModel.defaultChatSessionKey)"))
    }
    ...
    @Test func `iPad activity status text is typed presentation state`() throws {
        let source = try String(contentsOf: Self.iPadActivityScreenSourceURL(), encoding: .utf8)

        #expect(source.contains("struct IPadActivityGatewayDisplayStatusText: Equatable, Sendable"))
        #expect(source.contains(
    ...
    @Test func `command sessions refresh response action is typed`() throws {
        ...
        let commandCenterSource = try String(contentsOf: Self.commandCenterSourceURL(), encoding: .utf8)
        let commandSessionsScreen = try Self.extract(
            commandCenterSource,
            from: "struct CommandSessionsScreen: View",
            to: "extension NodeAppModel")
        let feature = try Self.extract(
            source,
        ...
        #expect(source.contains("struct CommandSessionEntries: Equatable, Sendable"))
        #expect(source.contains("struct CommandSessionsStatusPresentation: Equatable, Sendable"))
        #expect(source.contains("struct CommandSessionsScreenPresentation: Equatable, Sendable"))
        #expect(source.contains("var entries: [OpenClawChatSessionEntry] = []"))
        #expect(source.contains("case idle"))
        #expect(source.contains("case inFlight"))
        #expect(source.contains("struct CommandSessionsAvailable: Equatable, Sendable"))
        #expect(source.contains("struct CommandSessionsMode: Equatable, Sendable"))
        #expect(source.contains("let refreshTaskID: String"))
        #expect(feature.contains("var sessionEntries = CommandSessionEntries()"))
        #expect(feature.contains("var sessions: [OpenClawChatSessionEntry] {"))
        #expect(feature.contains("sessionEntries.entries"))
        #expect(!feature.contains("set { sessionEntries = .init(entries: newValue) }"))
        #expect(feature.contains("func sessionRows() -> [CommandCenterTab.WorkItem]"))
        #expect(feature.contains("func refreshTaskID("))
        #expect(feature.contains("sessionsMode: CommandSessionsMode"))
        #expect(feature.contains("refreshTaskID: self.refreshTaskID("))
        #expect(feature.contains("func screenPresentation("))
        #expect(feature.contains("let sessionRows = self.sessionRows()"))
        #expect(feature.contains("sessionRows: sessionRows"))
        ...
        #expect(commandSessionsScreen.contains("private var screenPresentation: CommandSessionsScreenPresentation"))
        #expect(commandSessionsScreen.contains("self.store.state.screenPresentation("))
        #expect(commandSessionsScreen.contains(".task(id: self.screenPresentation.refreshTaskID)"))
        #expect(commandSessionsScreen.contains("Text(self.screenPresentation.headerTitle)"))
        #expect(commandSessionsScreen.contains("if self.screenPresentation.showsLoadingIndicator"))
        #expect(commandSessionsScreen.contains("if let presentation = self.screenPresentation.unavailableSessionsPresentation"))
        #expect(commandSessionsScreen.contains("} else if self.screenPresentation.sessionRows.isEmpty"))
        #expect(commandSessionsScreen.contains("ForEach(self.screenPresentation.sessionRows)"))
        #expect(!commandSessionsScreen.contains("if self.store.loadingPhase == .inFlight"))
        #expect(!commandSessionsScreen.contains("if self.store.loadingPhase == .inFlight, self.store.sessions.isEmpty"))
        #expect(!commandCenterSource.contains("detail: loadErrorText.value"))
        #expect(commandSessionsScreen.contains("sessionsMode: .init(value: self.appModel.commandSessionListMode)"))
        #expect(commandSessionsScreen.contains("currentSession: .init(value: self.appModel.chatSessionKey)"))
        #expect(commandSessionsScreen.contains("defaultSession: .init(value: self.appModel.defaultChatSessionKey)"))
        #expect(!commandSessionsScreen.contains("].joined(separator: \":\")"))
        #expect(feature.contains("struct RefreshResponse: Equatable, Sendable"))
        #expect(feature.contains("struct SessionsAvailability: Equatable, Sendable"))
        ...
        #expect(feature.contains("case refreshResponse(RefreshResponse)"))
        #expect(feature.contains("var result: Result<CommandSessionEntries, CommandSessionsError>"))
        #expect(feature.contains("await send(.refreshResponse(.init(result: .success(.init(entries: sessions)))))"))
        #expect(feature.contains("switch response.result"))
        #expect(feature.contains("state.sessionEntries = .init()"))
        #expect(feature.contains("state.sessionEntries = sessionEntries"))
        ...
        #expect(!feature.contains("guard request.sessionsAvailability.isAvailable else"))
        #expect(!feature.contains("var sessionsAvailable: Bool"))
        #expect(!commandSessionsScreen.contains("private var refreshID: String"))
        #expect(!commandCenterSource.contains(
    ...
    @Test func `command center recent sessions refresh response action is typed`() throws {
        let source = try String(contentsOf: Self.commandSessionsFeatureSourceURL(), encoding: .utf8)
        let commandCenterSource = try String(contentsOf: Self.commandCenterSourceURL(), encoding: .utf8)
        let fullSessionsFeature = try Self.extract(
            source,
            from: "@Reducer\nstruct CommandSessionsFeature",
            to: "enum CommandSessionsStoreFactory")
        let commandSessionsScreen = try Self.extract(
        ...
        #expect(fullSessionsFeature.contains("var currentSession = CommandSessionReferenceKey(value: \"\")"))
        #expect(fullSessionsFeature.contains("var defaultSession = CommandSessionReferenceKey(value: \"\")"))
        #expect(fullSessionsFeature.contains("var visibleSessions: [OpenClawChatSessionEntry] {"))
        #expect(fullSessionsFeature.contains("defaultSessionKey: self.defaultSession.value"))
        #expect(fullSessionsFeature.contains(".sorted { ($0.updatedAt ?? 0) > ($1.updatedAt ?? 0) }"))
        #expect(fullSessionsFeature.contains("struct SessionReference: Equatable, Sendable"))
        #expect(fullSessionsFeature.contains("var currentSession: SessionReference"))
        #expect(fullSessionsFeature.contains("var defaultSession: SessionReference"))
        #expect(fullSessionsFeature.contains("state.currentSession = request.currentSession.key"))
        #expect(fullSessionsFeature.contains("state.defaultSession = request.defaultSession.key"))
        #expect(feature.contains("struct RefreshResponse: Equatable, Sendable"))
        #expect(feature.contains("struct SceneActivity: Equatable, Sendable"))
        #expect(feature.contains("struct SessionsAvailability: Equatable, Sendable"))
        ...
        #expect(source.contains("struct CommandSessionEntries: Equatable, Sendable"))
        #expect(source.contains("struct CommandSessionsAvailable: Equatable, Sendable"))
        #expect(source.contains("struct CommandCenterRecentSessionsPresentation: Equatable, Sendable"))
        #expect(source.contains("let defaultChatWorkItem: CommandCenterTab.WorkItem"))
        #expect(source.contains("let refreshTaskID: String"))
        #expect(feature.contains("var recentChatSessionEntries = CommandSessionEntries()"))
        #expect(feature.contains("var recentChatSessions: [OpenClawChatSessionEntry] {"))
        #expect(feature.contains("recentChatSessionEntries.entries"))
        #expect(!feature.contains("set { recentChatSessionEntries = .init(entries: newValue) }"))
        #expect(feature.contains("var defaultChatActivityText: String"))
        #expect(feature.contains("func defaultChatWorkItem("))
        #expect(feature.contains("activeAgentName: CommandCenterGatewayActiveAgentName"))
        #expect(feature.contains("func presentation("))
        #expect(feature.contains("sessionsMode: CommandSessionsMode"))
        #expect(feature.contains("sceneActivity: CommandSceneActive"))
        #expect(feature.contains("defaultChatWorkItem: self.defaultChatWorkItem("))
        #expect(feature.contains("previewRows: Array(rows.prefix(3))"))
        #expect(feature.contains("sceneActivity.value ? \"active\" : \"inactive\""))
        #expect(feature.contains("showsViewMore: rows.count > 3"))
        #expect(feature.contains("var recentChatSessionEntries: CommandSessionEntries"))
        #expect(feature.contains("struct SessionReference: Equatable, Sendable"))
        ...
        #expect(fullSessionsFeature.contains("CommandCenterTab.sessionWorkItem("))
        #expect(fullSessionsFeature.contains("currentSessionKey: self.currentSession.value"))
        #expect(!commandSessionsScreen.contains("self.store.visibleSessions"))
        #expect(!commandSessionsScreen.contains("currentSessionKey: self.store.currentSession.value"))
        #expect(commandCenterSource
        ...
        #expect(commandCenterSource.contains("private var recentSessionsPresentation: CommandCenterRecentSessionsPresentation"))
        #expect(commandCenterSource.contains(".task(id: self.recentSessionsPresentation.refreshTaskID)"))
        #expect(commandCenterSource.contains("CommandSessionRow(item: self.recentSessionsPresentation.defaultChatWorkItem)"))
        #expect(commandCenterSource.contains("self.recentSessionsStore.state.presentation("))
        #expect(commandCenterSource.contains("activeAgentName: .init(value: self.appModel.activeAgentName)"))
        #expect(commandCenterSource.contains("sessionsMode: .init(value: self.appModel.chatTransportModeID)"))
        #expect(commandCenterSource.contains("sceneActivity: .init(value: self.scenePhase == .active)"))
        #expect(commandCenterSource.contains("currentSession: .init(value: self.appModel.chatSessionKey)"))
        #expect(commandCenterSource.contains("defaultSession: .init(value: self.appModel.defaultChatSessionKey)"))
        #expect(commandCenterSource.contains("ForEach(self.recentSessionsPresentation.previewRows)"))
        #expect(commandCenterSource.contains("if self.recentSessionsPresentation.showsViewMore"))
        #expect(!commandCenterSource.contains("private var recentSessionsRefreshID"))
        #expect(!commandCenterSource.contains("private var sessionListMode"))
        #expect(!commandCenterSource.contains("private var defaultChatWorkItem"))
        #expect(!commandCenterSource.contains("private var defaultChatActivityText"))
        #expect(!commandCenterSource.contains("private var recentSessionPreviewRows"))
        #expect(!commandCenterSource.contains("private var hasMoreRecentSessions"))
        #expect(!commandCenterSource.contains("private var sessionWorkItems"))
        #expect(feature.contains("case refreshResponse(RefreshResponse)"))
        #expect(feature.contains("await send(.refreshResponse(.init(result: .success(snapshot))))"))
        #expect(feature.contains("switch response.result"))
        #expect(feature.contains("state.recentChatSessionEntries = .init()"))
        #expect(feature.contains("state.recentChatSessionEntries = snapshot.recentChatSessionEntries"))
        #expect(source.contains("recentChatSessionEntries: .init(entries: self.sessionChoices("))
        #expect(!feature.contains("var recentChatSessions: [OpenClawChatSessionEntry] = []"))
        #expect(!feature.contains("var recentChatSessions: [OpenClawChatSessionEntry]\n"))
        #expect(!feature.contains("var sceneActive: Bool"))
        #expect(!feature.contains("var sessionsAvailable: Bool"))
        ...
        #expect(!feature.contains("var currentSessionKey: String"))
        #expect(!feature.contains("var defaultSessionKey: String"))
        #expect(!commandSessionsScreen.contains("self.store.sessions\n            .filter"))
        #expect(!commandSessionsScreen.contains("defaultSessionKey: self.appModel.defaultChatSessionKey"))
    ...
    @Test func `command center chat routes use typed payload`() throws {
        ...
        #expect(activitySource.contains("var openChat: @Sendable @MainActor (_ route: CommandCenterTab.ChatRoute) -> Void"))
        #expect(activitySource.contains("case chatRouteOpened(ChatRouteOpenRequest)"))
        #expect(activitySource.contains("await client.openChat(request.route)"))
        #expect(activitySource.contains("await self.store.send(.chatRouteOpened(.init(route: route))).finish()"))
    ...
    @Test func `routed gateway pills open gateway settings`() throws {
        ...
        #expect(navigationSource.contains("state.sidebarNavigationPathState.routes.removeAll()"))
        #expect(navigationSource.contains("state.sidebarNavigationPathState = change.path"))
        #expect(navigationSource.contains("state.sidebarNavigationPathState = .init(routes: [push.route])"))
        ...
        #expect(!navigationSource.contains("state.sidebarNavigationPath = change.path"))
        ...
        #expect(rootSource.contains("RootNavigationSelectionFeature.SidebarNavigationPathChange(path: .init(routes: $0))"))
        ...
        #expect(settingsTabSource.contains("struct SettingsNavigationPath: Equatable, Sendable"))
        #expect(settingsTabSource.contains("var navigationPathState = SettingsNavigationPath(routes: [])"))
        #expect(settingsTabSource.contains("var navigationPath: [SettingsRoute]"))
        #expect(settingsTabSource.contains("self.navigationPathState.routes"))
        ...
        #expect(settingsTabSource.contains("var path: SettingsNavigationPath"))
        #expect(settingsTabSource.contains("state.navigationPathState = path"))
        #expect(settingsTabSource.contains("state.navigationPathState = change.path"))
        #expect(settingsTabSource.contains("state.navigationPathState = .init(routes: [request.route])"))
        ...
        #expect(!settingsTabSource.contains("var navigationPath: [SettingsRoute] = []"))
        #expect(!settingsTabSource.contains("struct NavigationPathChange: Equatable, Sendable { var path: [SettingsRoute] }"))
        #expect(!settingsTabSource.contains("state.navigationPath = change.path"))
        #expect(!settingsTabSource.contains("state.navigationPath = [request.route]"))
    ...
    @Test func `local network access is requested from visible gateway flows`() throws {
        ...
        let statusStoreDeclaration = try Self.extract(
            onboardingSource,
            from: "@State private var statusStore",
            to: "@State private var presentationStore")
        ...
        let setupCodeStoreDeclaration = try Self.extract(
            onboardingSource,
        ...
        #expect(onboardingStateSource.contains("localNetworkReason: .init(value: \"onboarding_continue\")"))
        #expect(onboardingSource.contains("self.applyIntroAdvanceRequest(OnboardingStatusFeature.introAdvanceRequest)"))
        #expect(onboardingSource.contains("self.requestLocalNetworkAccess(reason: request.localNetworkReason.value)"))
        ...
        #expect(rootSource.contains("credentialsStore: self.makeOnboardingCredentialsStore()"))
        #expect(storesSource.contains("func makeOnboardingCredentialsStore()"))
        #expect(storesSource
            .contains("OnboardingCredentialsFeature(setupAuthPersistenceClient: .live(appModel: self.appModel))"))
        ...
        #expect(rootSource.contains("statusStore: self.makeOnboardingStatusStore()"))
        #expect(storesSource.contains("func makeOnboardingStatusStore()"))
        #expect(storesSource.contains("OnboardingStatusFeature("))
        #expect(storesSource.contains("retryConnectionClient: .live(gatewayController: self.gatewayController)"))
        #expect(onboardingStateSource.contains("struct OnboardingRetryConnectionClient"))
        #expect(onboardingStateSource.contains("var onboardingRetryConnection: OnboardingRetryConnectionClient"))
        #expect(onboardingStateSource.contains("case retryConnectionRequested(RetryConnectionRequest)"))
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingRetryConnection)"))
        #expect(onboardingStateSource.contains("await retryConnectionClient.connectLastKnown()"))
        #expect(onboardingStateSource.contains("await send(.connectionFinished)"))
        ...
        #expect(storesSource.contains("OnboardingGatewayConnectionFeature("))
        #expect(storesSource.contains("disconnectClient: .live(appModel: self.appModel)"))
        #expect(storesSource.contains(
            "discoveredGatewayConnectionClient: .live(gatewayController: self.gatewayController)"))
        #expect(onboardingStateSource.contains("struct OnboardingGatewayDisconnectClient"))
        #expect(onboardingStateSource.contains("struct OnboardingDiscoveredGatewayConnectionClient"))
        ...
        #expect(onboardingStateSource
            .contains("var onboardingDiscoveredGatewayConnection: OnboardingDiscoveredGatewayConnectionClient"))
        ...
        #expect(onboardingStateSource
            .contains("case discoveredGatewayConnectionEffectRequested(DiscoveredGatewayConnectionRequest)"))
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingGatewayDisconnect)"))
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingDiscoveredGatewayConnection)"))
        #expect(onboardingStateSource.contains("await disconnectClient.disconnect()"))
        #expect(onboardingStateSource.contains("await discoveredGatewayConnectionClient.connect(request.id)"))
        ...
        #expect(rootSource.contains("connectionFormStore: self.makeOnboardingConnectionFormStore()"))
        #expect(storesSource.contains("func makeOnboardingConnectionFormStore()"))
        #expect(storesSource.contains("OnboardingConnectionFormFeature("))
        #expect(storesSource.contains("manualConnectionClient: .live(gatewayController: self.gatewayController)"))
        ...
        #expect(onboardingStateSource.contains("var onboardingGatewaySetupAuthPersistence"))
        #expect(onboardingStateSource
        ...
        #expect(!onboardingStateSource.contains("var restartRequestID = 0"))
        #expect(!onboardingStateSource.contains("state.restartRequestID &+= 1"))
        ...
        #expect(onboardingStateSource.contains("var message: OnboardingQRPhotoImportFailureMessage"))
        #expect(onboardingStateSource.contains(
        ...
        #expect(onboardingStateSource.contains("private static func failureResult("))
        #expect(onboardingStateSource.contains("presentationError: .init(message: .init(value: message.value))"))
        #expect(onboardingSource.contains(".qrScannerErrorReceived(failure.presentationError)"))
    ...
    @Test func `native chat uses gateway transport`() throws {
        ...
        #expect(chatSource.contains("struct ChatTalkControlSnapshot: Equatable, Sendable"))
        #expect(chatSource.contains("struct ChatTalkControlStatusText: Equatable, Sendable"))
        #expect(chatSource.contains("struct ChatTalkControlProviderLabel: Equatable, Sendable"))
        #expect(chatSource.contains("var snapshot = ChatTalkControlSnapshot()"))
        #expect(chatSource.contains("private var talkControlState: ChatTalkControlSnapshot"))
        #expect(chatSource.contains("private var currentTalkControlSnapshot: ChatTalkControlSnapshot"))
        #expect(chatSource.contains("self.talkControlStore.send(.snapshotChanged(.init(snapshot: snapshot)))"))
        #expect(chatSource.contains("isEnabled: control.isEnabled"))
        #expect(chatSource.contains("talkEnabled: .init(isEnabled: control.isEnabled)"))
        #expect(!chatSource.contains("talkEnabled: .init(isEnabled: self.appModel.talkMode.isEnabled)"))
        ...
        #expect(chatSource.contains("struct ChatProGatewayUsability: Equatable, Sendable"))
        #expect(chatSource.contains("var gatewayUsabilityValue = ChatProGatewayUsability(value: false)"))
        #expect(chatSource.contains("isGatewayUsable: Bool = false"))
        #expect(chatSource.contains("self.gatewayUsabilityValue = .init(value: isGatewayUsable)"))
        #expect(chatSource.contains("var isGatewayUsable: Bool"))
        #expect(chatSource.contains("self.gatewayUsabilityValue.value"))
        #expect(!chatSource.contains("var isGatewayUsable = false"))
        #expect(chatSource.contains("struct ChatProPresentationSnapshot: Equatable, Sendable"))
        #expect(chatSource.contains("struct ChatProAgentEntry: Equatable, Sendable"))
        #expect(chatSource.contains("struct ChatProAgentEntries: Equatable, Sendable"))
        #expect(chatSource.contains("init(agent: AgentSummary)"))
        #expect(chatSource.contains("var snapshot = ChatProPresentationSnapshot()"))
        #expect(chatSource.contains("var presentation: ChatProPresentationState"))
        #expect(chatSource.contains("case snapshotChanged(SnapshotChange)"))
        #expect(chatSource.contains(".init(snapshot: self.snapshot)"))
        #expect(chatSource.contains("agents: self.appModel.gatewayAgents.map(ChatProAgentEntry.init(agent:))"))
        #expect(!chatSource.contains("var presentation = ChatProPresentationState()"))
        #expect(!chatSource.contains("case presentationChanged(PresentationChange)"))
        #expect(!chatSource.contains("private var activeAgent: AgentSummary?"))
        #expect(!chatSource.contains("private var agentDisplayName: String"))
        #expect(!chatSource.contains("private var agentBadgeOverride: String?"))
        ...
        #expect(chatSource.contains("struct ChatProHeaderTitle: Equatable, Sendable"))
        #expect(chatSource.contains("var headerTitleValue = ChatProHeaderTitle(value: nil)"))
        #expect(chatSource.contains("headerTitle: String? = nil"))
        #expect(chatSource.contains("self.headerTitleValue = .init(value: headerTitle)"))
        ...
        #expect(!chatSource.contains("var headerSubtitle: String?\n    var showsAgentBadge"))
        #expect(chatSource.contains("struct ChatProShowsAgentBadge: Equatable, Sendable"))
        #expect(chatSource.contains("var showsAgentBadgeValue = ChatProShowsAgentBadge(value: true)"))
        #expect(chatSource.contains("showsAgentBadge: Bool = true"))
        #expect(chatSource.contains("self.showsAgentBadgeValue = .init(value: showsAgentBadge)"))
        ...
        #expect(channelsSource.contains("var channelEntries = SettingsChannelEntries()"))
        #expect(channelsSource.contains("var entries: [SettingsChannelEntry] {"))
        #expect(channelsSource.contains("self.channelEntries.values"))
        #expect(channelsSource.contains("var configuredEntryCount: Int"))
        #expect(channelsSource.contains("var hasActiveEntry: Bool"))
        #expect(channelsSource.contains("func headerValue(canRead: Bool) -> String?"))
        #expect(channelsSource.contains("func summaryValue(canRead: Bool) -> String"))
        #expect(channelsSource.contains("self.store.state.headerValue(canRead: self.canRead)"))
        #expect(channelsSource.contains("self.store.state.summaryValue(canRead: self.canRead)"))
        #expect(channelsSource.contains("self.store.hasActiveEntry ? OpenClawBrand.ok"))
        #expect(channelsSource.contains("ForEach(Array(self.store.entries.enumerated()), id: \\.element.id)"))
        #expect(!channelsSource.contains("var entries: [SettingsChannelEntry] = []"))
        #expect(!channelsSource.contains("set { channelEntries = .init(values: newValue) }"))
        #expect(!channelsSource.contains("private var channelEntries: [SettingsChannelEntry]"))
        ...
        #expect(channelsSource.contains("if self.loadingPhase == .inFlight { return \"Loading\" }"))
        #expect(channelsSource.contains("if self.loadingPhase == .inFlight { return \"loading\" }"))
        ...
        #expect(channelsSource.contains("var result: Result<SettingsChannelEntries, SettingsChannelsError>"))
        ...
        #expect(channelsSource.contains("state.channelEntries = .init()"))
        #expect(channelsSource.contains("state.channelEntries = channelEntries"))
    ...
    @Test func `onboarding qr scanner errors are reducer owned`() throws {
        ...
        #expect(onboardingStateSource.contains("var statusError: OnboardingStatusFeature.Action.ScannerError"))
        #expect(onboardingStateSource.contains(".init(message: self.message)"))
        ...
        #expect(onboardingSource.contains("self.presentationStore.send(.qrScannerErrorReceived(scannerError))"))
        #expect(onboardingSource.contains(
        ...
        #expect(!onboardingSource.contains("self.statusStore.send(.scannerErrorReceived(.init(message: .init(value: error))))"))
        #expect(!onboardingSource.contains(
            "self.presentationStore.send(.qrScannerErrorReceived(.init(message: .init(value: error))))"))
        #expect(!onboardingSource.contains(
    ...
    @Test func `onboarding completion mark action is typed`() throws {
        ...
        #expect(onboardingFeatureSource.contains("struct IntroAdvanceRequest: Equatable, Sendable"))
        #expect(onboardingFeatureSource.contains("struct LocalNetworkReason: Equatable, Sendable"))
        #expect(onboardingFeatureSource.contains("var stateAction: OnboardingStateFeature.Action"))
        #expect(onboardingFeatureSource.contains("var localNetworkReason: LocalNetworkReason"))
        ...
        #expect(onboardingFeatureSource.contains("static let introAdvanceRequest = IntroAdvanceRequest("))
        #expect(onboardingFeatureSource.contains("stateAction: .markFirstRunIntroSeen"))
        #expect(onboardingFeatureSource.contains("localNetworkReason: .init(value: \"onboarding_continue\")"))
        #expect(onboardingFeatureSource.contains("statusAction: .introAdvanced"))
        #expect(onboardingFeatureSource.contains("stepAction: .stepChanged(.init(step: .welcome))"))
        #expect(introFunction.contains("self.applyIntroAdvanceRequest(OnboardingStatusFeature.introAdvanceRequest)"))
        #expect(introFunction.contains("self.onboardingStateStore.send(request.stateAction)"))
        #expect(introFunction.contains("self.requestLocalNetworkAccess(reason: request.localNetworkReason.value)"))
        #expect(introFunction.contains("self.statusStore.send(request.statusAction)"))
        #expect(introFunction.contains("self.stepStore.send(request.stepAction)"))
    ...
    @Test func `onboarding gateway connected action is typed`() throws {
        ...
        #expect(onboardingStateSource
            .contains("struct GatewayConnectionSuccessTransitionRequest: Equatable, Sendable"))
        ...
        #expect(onboardingStateSource.contains("var handledStatusAction: OnboardingStatusFeature.Action"))
        #expect(onboardingStateSource.contains("static func gatewayConnectionSuccessTransitionRequest("))
        #expect(onboardingStateSource.contains("presentationAction: .qrScannerDismissed"))
        #expect(onboardingStateSource
            .contains("statusAction: .gatewayConnectionSucceeded(.init(selectedMode: selectedMode))"))
        #expect(onboardingStateSource.contains("handledStatusAction: .gatewayConnectionSuccessHandled"))
        #expect(onboardingStateSource.contains("stepAction: .stepChanged(.init(step: .success))"))
        #expect(onboardingStateSource.contains(
        ...
        #expect(onboardingSource.contains("let transitionRequest = OnboardingStatusFeature"))
        #expect(onboardingSource.contains(
            ".gatewayConnectionSuccessTransitionRequest(selectedMode: self.selectedMode)"))
        #expect(onboardingSource.contains("self.presentationStore.send(transitionRequest.presentationAction)"))
        #expect(onboardingSource.contains("self.statusStore.send(transitionRequest.statusAction)"))
        #expect(onboardingSource.contains("self.statusStore.gatewayConnectionCompletionRequest"))
        #expect(onboardingSource.contains("self.onboardingStateStore.send(.markCompleted(completionRequest))"))
        #expect(onboardingSource.contains("self.statusStore.send(transitionRequest.handledStatusAction)"))
        #expect(onboardingSource.contains("self.stepStore.send(transitionRequest.stepAction)"))
        #expect(!onboardingSource.contains(
    ...
    @Test func `onboarding automatic pairing resume action is typed`() throws {
        ...
        let statusFeatureSource = try Self.extract(
            ...
            to: "struct OnboardingPresentationFeature")
        ...
        #expect(onboardingStateSource.contains("struct OnboardingPairingResumeClockClient"))
        #expect(onboardingStateSource.contains("var onboardingPairingResumeClock: OnboardingPairingResumeClockClient"))
        #expect(onboardingStateSource.contains("private let clockOverride: OnboardingPairingResumeClockClient?"))
        ...
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingPairingResumeClock) var dependencyClock"))
        #expect(onboardingStateSource.contains("let clock = self.clockOverride ?? dependencyClock"))
        #expect(onboardingStateSource.contains("case automaticPairingResumeRequested"))
        #expect(onboardingStateSource.contains("let requestTime = clock.now()"))
        #expect(onboardingStateSource.contains("requestTime.value.timeIntervalSince(last)"))
        #expect(onboardingStateSource.contains("state.lastPairingAutoResumeAttemptState = requestTime"))
        ...
        #expect(onboardingSource.contains("self.statusStore.send(.automaticPairingResumeRequested)"))
        #expect(!onboardingSource.contains("self.statusStore.send(.automaticPairingResumeRequested(.init("))
        #expect(!onboardingSource.contains("Date()"))
        #expect(!onboardingStateSource.contains("struct AutomaticPairingResumeRequest"))
        #expect(!onboardingStateSource.contains("@Dependency(\\.date"))
    ...
    @Test func `onboarding status reducer stores flow flags as typed state`() throws {
        ...
        #expect(onboardingStateSource.contains("struct IntroAdvanceRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct LocalNetworkReason: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct AuthStepNavigationRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct NavigationBackRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct QRScannerOpeningRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("var stateAction: OnboardingStateFeature.Action"))
        #expect(onboardingStateSource.contains("var localNetworkReason: LocalNetworkReason"))
        #expect(onboardingStateSource.contains("var statusAction: OnboardingStatusFeature.Action"))
        #expect(onboardingStateSource.contains("var stepAction: OnboardingStepFeature.Action"))
        #expect(onboardingStateSource.contains("var presentationAction: OnboardingPresentationFeature.Action"))
        #expect(onboardingStateSource.contains("static let introAdvanceRequest = IntroAdvanceRequest("))
        #expect(onboardingStateSource.contains("static let navigationBackRequest = NavigationBackRequest("))
        ...
        #expect(onboardingStateSource.contains("stateAction: .markFirstRunIntroSeen"))
        #expect(onboardingStateSource.contains("localNetworkReason: .init(value: \"onboarding_continue\")"))
        #expect(onboardingStateSource.contains("statusAction: .introAdvanced"))
        #expect(onboardingStateSource.contains("stepAction: .stepChanged(.init(step: .welcome))"))
        #expect(onboardingStateSource.contains("statusAction: .navigationBackStarted"))
        #expect(onboardingStateSource.contains("stepAction: .backButtonTapped"))
        ...
        #expect(onboardingSource.contains("self.applyNavigationBackRequest(OnboardingStatusFeature.navigationBackRequest)"))
        #expect(onboardingSource.contains(
        ...
        #expect(onboardingSource.contains("self.stepStore.send(request.stepAction)"))
        ...
        #expect(statusStateBlock.contains("var authStepNavigationRequest: AuthStepNavigationRequest?"))
        #expect(onboardingStateSource.contains("state.authStepPresentation = .init(shouldShow:"))
        #expect(onboardingStateSource.contains("case authStepNavigationHandled"))
        #expect(onboardingStateSource.contains("state.authStepNavigationRequest = nil"))
        #expect(onboardingStateSource.contains("? .init(stepAction: .stepChanged(.init(step: .auth)))"))
        #expect(!onboardingSource.contains("""
    ...
    @Test func `scanner gateway link results are reducer owned`() throws {
        ...
        #expect(onboardingStateSource.contains("state.scannedGatewayLinkTransitionRequest = "))
        #expect(onboardingStateSource.contains("private static func scannedGatewayLinkTransitionRequest("))
        #expect(onboardingStateSource.contains("presentationAction: .qrScannerDismissed"))
        #expect(onboardingStateSource.contains("statusAction: .connectionStatusUpdated(.init("))
        ...
        #expect(onboardingSource.contains("self.setupCodeStore.scannedGatewayLinkTransitionRequest"))
        #expect(onboardingSource.contains("self.presentationStore.send(transitionRequest.presentationAction)"))
        #expect(onboardingSource.contains("self.statusStore.send(transitionRequest.statusAction)"))
        #expect(onboardingSource.contains("self.stepStore.send(transitionRequest.stepAction)"))
    ...
    @Test func `settings manual port resolution status is reducer owned`() throws {
        ...
        #expect(settingsSource.contains("@State var manualGatewayPortStore: StoreOf<SettingsManualGatewayPortFeature>"))
    ...
    @Test func `settings gateway auto connect toggle is reducer typed`() throws {
        ...
        #expect(autoConnectFeature.contains("var enabled = GatewayAutoConnectEnabled(value: false)"))
        #expect(!autoConnectFeature.contains("Action.GatewayAutoConnectEnabled"))
    ...
    @Test func `settings gateway connection status sync action is typed`() throws {
        ...
        #expect(connectionSource.contains("var gatewayAgentCount = GatewayAgentCount(value: 0)"))
        ...
        #expect(connectionSource.contains("var gatewayStatusConnected = GatewayConnectionStatusConnected(value: false)"))
        #expect(connectionSource.contains("var isAppleReviewDemoModeEnabled = GatewayAppleReviewDemoModeEnabled(value: false)"))
        ...
        #expect(!connectionSource.contains("Action.GatewayAgentCount"))
        #expect(!connectionSource.contains("Action.GatewayConnectionStatusConnected"))
        #expect(!connectionSource.contains("Action.GatewayAppleReviewDemoModeEnabled"))
    ...
    @Test func `settings share instruction persistence is reducer owned`() throws {
        ...
        #expect(settingsSource.contains("@State var shareInstructionStore: StoreOf<SettingsShareInstructionFeature>"))
    ...
    @Test func `onboarding setup code apply result is reducer owned`() throws {
        ...
        let gatewayTokenChange = try Self.extract(
            ...
            to: "struct ManualCredentialPersistenceRequest")
        let manualCredentialInputChange = try Self.extract(
            onboardingStateSource,
            from: "struct OnboardingManualCredentialInputChange",
            to: "struct OnboardingGatewayStoredCredentials")
        ...
        let applyGatewayLinkFunction = try Self.extract(
            ...
            from: "func applyGatewayLink(_ link: GatewayConnectDeepLink) async",
            to: "func handleScannedSetupCode")
        let updateGatewayTokenFunction = try Self.extract(
            onboardingSource,
            from: "private func updateGatewayToken(_ value: String)",
            to: "private func updateGatewayPassword(_ value: String)")
        let updateGatewayPasswordFunction = try Self.extract(
            onboardingSource,
            from: "private func updateGatewayPassword(_ value: String)",
            to: "private func connectDiscoveredGateway")
        ...
        #expect(onboardingStateSource.contains("struct OnboardingGatewayCredentialInput: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct OnboardingGatewayStoredCredentials: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct OnboardingGatewayCredentialValue: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct OnboardingGatewayCredentialsPersistenceClient"))
        #expect(onboardingStateSource.contains("var loadCredentials: @Sendable (_ instanceId: OnboardingGatewayCurrentInstanceID)"))
        #expect(onboardingStateSource.contains("GatewaySettingsStore.loadGatewayToken(instanceId: instanceId)"))
        #expect(onboardingStateSource.contains("GatewaySettingsStore.loadGatewayPassword(instanceId: instanceId)"))
        #expect(onboardingStateSource.contains("struct CredentialsLoadRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct ManualCredentialPersistenceRequest: Equatable, Sendable"))
        ...
        #expect(manualCredentialInputChange.contains("var instanceId: OnboardingGatewayCurrentInstanceID"))
        #expect(onboardingStateSource.contains("case credentialsLoadRequested(CredentialsLoadRequest)"))
        ...
        #expect(onboardingStateSource.contains("case gatewayTokenInputChanged(OnboardingManualCredentialInputChange)"))
        #expect(onboardingStateSource.contains("case gatewayPasswordInputChanged(OnboardingManualCredentialInputChange)"))
        #expect(onboardingStateSource.contains("case gatewayTokenPersistenceRequested(ManualCredentialPersistenceRequest)"))
        #expect(onboardingStateSource.contains("case gatewayPasswordPersistenceRequested(ManualCredentialPersistenceRequest)"))
        #expect(onboardingStateSource.contains("case setupAuthApplied(SetupAuthApplication)"))
        #expect(onboardingStateSource.contains("case setupLinkApplied(SetupLinkApplication)"))
        #expect(onboardingStateSource
            .contains("case setupAuthPersistenceRequested(OnboardingGatewaySetupAuthPersistenceRequest)"))
        ...
        #expect(onboardingStateSource.contains("var gatewayTokenState = OnboardingGatewayToken(value: \"\")"))
        #expect(onboardingStateSource.contains("var gatewayPasswordState = OnboardingGatewayPassword(value: \"\")"))
        #expect(onboardingStateSource.contains("var gatewayToken: String {\n            self.gatewayTokenState.value"))
        #expect(onboardingStateSource.contains("var gatewayPassword: String {\n            self.gatewayPasswordState.value"))
        #expect(onboardingStateSource.contains("let credentials = credentialsPersistenceClient.loadCredentials(request.instanceId)"))
        #expect(onboardingStateSource.contains("guard request.instanceId.trimmedValue != nil else { return .none }"))
        #expect(onboardingStateSource.contains("state.gatewayTokenState = .init(value: credentials.token)"))
        #expect(onboardingStateSource.contains("state.gatewayPasswordState = .init(value: credentials.password)"))
        #expect(onboardingStateSource.contains("state.gatewayTokenState = credentials.token"))
        #expect(onboardingStateSource.contains("state.gatewayPasswordState = credentials.password"))
        #expect(onboardingStateSource.contains("state.gatewayTokenState = change.token"))
        #expect(onboardingStateSource.contains("state.gatewayPasswordState = change.password"))
        #expect(onboardingStateSource.contains("case let .gatewayTokenInputChanged(change):"))
        #expect(onboardingStateSource.contains("case let .gatewayPasswordInputChanged(change):"))
        #expect(onboardingStateSource.contains("state.gatewayTokenState = .init(value: change.value.value)"))
        #expect(onboardingStateSource.contains("state.gatewayPasswordState = .init(value: change.value.value)"))
        #expect(onboardingStateSource.contains("value: .init(rawValue: change.value.value)"))
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingGatewayCredentialsPersistence)"))
        #expect(onboardingStateSource.contains("manualCredentialPersistenceRequest("))
        #expect(onboardingStateSource.contains("await credentialsPersistenceClient.saveGatewayToken("))
        #expect(onboardingStateSource.contains("await credentialsPersistenceClient.saveGatewayPassword("))
        #expect(onboardingStateSource.contains("state.gatewayTokenState = .init(value: setupAuth.token)"))
        ...
        #expect(onboardingStateSource.contains("await setupAuthPersistenceClient.prepareForBootstrapPairing"))
        #expect(onboardingStateSource.contains("await setupAuthPersistenceClient.saveSetupAuth(request)"))
        #expect(onboardingSource.contains("set: { self.updateGatewayToken($0) }"))
        #expect(onboardingSource.contains("set: { self.updateGatewayPassword($0) }"))
        #expect(updateGatewayTokenFunction.contains("self.credentialsStore.send(.gatewayTokenInputChanged(.init("))
        #expect(updateGatewayTokenFunction.contains("value: .init(value: value)"))
        #expect(updateGatewayTokenFunction.contains("instanceId: .init(value: self.instanceId)"))
        #expect(updateGatewayPasswordFunction.contains("self.credentialsStore.send(.gatewayPasswordInputChanged(.init("))
        #expect(updateGatewayPasswordFunction.contains("value: .init(value: value)"))
        #expect(updateGatewayPasswordFunction.contains("instanceId: .init(value: self.instanceId)"))
        ...
        #expect(!manualCredentialInputChange.contains("var value: String"))
        #expect(!onboardingSource.contains("GatewaySettingsStore.loadGatewayToken"))
        #expect(!onboardingSource.contains("GatewaySettingsStore.loadGatewayPassword"))
        #expect(!onboardingSource.contains("self.credentialsStore.send(.credentialsLoaded(.init("))
        #expect(!onboardingStateSource.contains("var gatewayToken = \"\""))
        #expect(!onboardingStateSource.contains("var gatewayPassword = \"\""))
        ...
        #expect(!onboardingStateSource.contains("state.gatewayToken = \"\""))
        #expect(!onboardingStateSource.contains("state.gatewayPassword = \"\""))
        #expect(!applyGatewayLinkFunction
            .contains("GatewayConnectionController.ManualAuthOverride.setupAuth(from: link)"))
        #expect(!applyGatewayLinkFunction.contains(".setupAuthApplied(setupAuth)"))
        #expect(!applyGatewayLinkFunction.contains("GatewayOnboardingReset.prepareForBootstrapPairing"))
        ...
        #expect(!applyGatewayLinkFunction.contains("GatewaySettingsStore.saveGatewayToken"))
        #expect(!applyGatewayLinkFunction.contains("GatewaySettingsStore.saveGatewayPassword"))
        #expect(!onboardingSource.contains("private func saveGatewayCredentials"))
        #expect(!onboardingSource.contains(".onChange(of: self.gatewayToken)"))
        #expect(!onboardingSource.contains(".onChange(of: self.gatewayPassword)"))
        #expect(!updateGatewayTokenFunction.contains("GatewaySettingsStore.saveGatewayToken"))
        #expect(!updateGatewayPasswordFunction.contains("GatewaySettingsStore.saveGatewayPassword"))
        #expect(!updateGatewayTokenFunction.contains("gatewayTokenChanged"))
        #expect(!updateGatewayTokenFunction.contains("gatewayTokenPersistenceRequested"))
        #expect(!updateGatewayPasswordFunction.contains("gatewayPasswordChanged"))
        #expect(!updateGatewayPasswordFunction.contains("gatewayPasswordPersistenceRequested"))
    ...
    @Test func `onboarding manual connection request is reducer owned`() throws {
        ...
        let manualConnectionRequest = try Self.extract(
            ...
            to: "enum Action")
        let manualConnectionEffectRequest = try Self.extract(
            onboardingStateSource,
            from: "struct ManualConnectionEffectRequest",
            to: "struct ManualHostChange")
        ...
        #expect(onboardingStateSource.contains("struct OnboardingConnectionFormDefaults: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct OnboardingConnectionFormDefaultsClient"))
        #expect(onboardingStateSource.contains("var loadDefaults: @Sendable () -> OnboardingConnectionFormDefaults"))
        #expect(onboardingStateSource.contains("var savedGatewayConnection = OnboardingHasSavedGatewayConnection(value: false)"))
        #expect(onboardingStateSource.contains("var hasSavedGatewayConnection: Bool"))
        ...
        #expect(onboardingStateSource.contains("struct InitializationStatusEvaluation: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct CredentialPresence: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct GatewayLinkApplication: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("case initialConnectionLoadRequested"))
        #expect(onboardingStateSource.contains("case initializationStatusEvaluated(InitializationStatusEvaluation)"))
        ...
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingConnectionFormDefaults)"))
        #expect(onboardingStateSource.contains("Self.applyInitialization(defaultsClient.loadDefaults(), to: &state)"))
        #expect(onboardingStateSource.contains("private static func applyInitialization("))
        ...
        #expect(onboardingStateSource.contains("state.savedGatewayConnection = initialization.hasSavedGatewayConnection"))
        ...
        #expect(onboardingStateSource.contains("guard !evaluation.hasSavedGatewayConnection.value"))
        #expect(onboardingStateSource.contains("!evaluation.hasGatewayToken.value"))
        #expect(onboardingStateSource.contains("!evaluation.hasGatewayPassword.value"))
        #expect(onboardingStateSource.contains("state.statusLineState = .init(value: Self.noSavedPairingStatusLine)"))
        #expect(onboardingSource.contains("self.connectionFormStore.send(.initialConnectionLoadRequested)"))
        #expect(onboardingSource.contains("self.statusStore.send(.initializationStatusEvaluated(.init("))
        #expect(onboardingSource.contains(
            "hasSavedGatewayConnection: .init(value: self.connectionFormStore.hasSavedGatewayConnection)"))
        #expect(onboardingSource.contains("hasGatewayToken: .init(value: self.credentialsStore.hasGatewayToken)"))
        #expect(onboardingSource.contains("hasGatewayPassword: .init(value: self.credentialsStore.hasGatewayPassword)"))
        #expect(!onboardingSource.contains("!self.connectionFormStore.hasSavedGatewayConnection"))
        ...
        #expect(onboardingStateSource.contains("struct ManualConnectionEffectRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("struct OnboardingManualConnectionClient"))
        #expect(onboardingStateSource.contains("var onboardingManualConnection: OnboardingManualConnectionClient"))
        ...
        #expect(manualConnectionRequest.contains("var statusAction: OnboardingStatusFeature.Action"))
        #expect(!manualConnectionRequest.contains("var connectionStart: OnboardingStatusFeature.Action.ConnectionStart"))
        #expect(manualConnectionEffectRequest.contains("var request: ManualConnectionRequest"))
        #expect(manualConnectionEffectRequest
            .contains("var authOverride: GatewayConnectionController.ManualAuthOverride?"))
        ...
        #expect(onboardingStateSource.contains("case manualConnectionEffectRequested(ManualConnectionEffectRequest)"))
        ...
        #expect(onboardingStateSource.contains("@Dependency(\\.onboardingManualConnection)"))
        #expect(onboardingStateSource.contains("await manualConnectionClient.connect("))
        ...
        #expect(connectManualFunction.contains("self.statusStore.send(request.statusAction)"))
        #expect(connectManualFunction.contains(".send(.manualConnectionEffectRequested(.init("))
        #expect(connectManualFunction.contains("request: request"))
        #expect(connectManualFunction.contains("authOverride: authOverride"))
        #expect(!connectManualFunction.contains("self.statusStore.send(.connectionStarted(request.connectionStart))"))
        ...
        #expect(onboardingStateSource.contains("host: host.value"))
        #expect(onboardingStateSource.contains("port: port.value"))
        #expect(onboardingStateSource.contains("useTLS: useTLS.value"))
        #expect(!connectManualFunction.contains("self.gatewayController.connectManual("))
        ...
        #expect(!onboardingSource.contains("GatewaySettingsStore.loadLastGatewayConnection"))
        #expect(!onboardingSource.contains("OnboardingStateStore.lastMode()"))
    ...
    @Test func `onboarding discovered gateway connection presentation is reducer owned`() throws {
        ...
        #expect(onboardingStateSource.contains("struct OnboardingDiscoveryStatusText: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("var trimmedValue: String?"))
        #expect(gatewayConnectionFeature.contains("struct DiscoveredGatewayRow: Equatable, Identifiable, Sendable"))
        #expect(gatewayConnectionFeature.contains("var connectionID: OnboardingConnectionID"))
        #expect(gatewayConnectionFeature.contains("var name: OnboardingDiscoveredGatewayName"))
        #expect(gatewayConnectionFeature.contains("var lanHost: OnboardingDiscoveredGatewayHost"))
        #expect(gatewayConnectionFeature.contains("var tailnetDNS: OnboardingDiscoveredGatewayHost"))
        #expect(gatewayConnectionFeature.contains("var discoveredGatewayRows: [DiscoveredGatewayRow] = []"))
        #expect(gatewayConnectionFeature
            .contains("var discoveryStatusTextState = OnboardingDiscoveryStatusText(value: \"Idle\")"))
        #expect(gatewayConnectionFeature.contains("var discoveryStatusText: String"))
        #expect(gatewayConnectionFeature.contains("struct DiscoverySnapshot: Equatable, Sendable"))
        #expect(gatewayConnectionFeature.contains("var statusText: OnboardingDiscoveryStatusText"))
        #expect(gatewayConnectionFeature.contains("var rows: [State.DiscoveredGatewayRow]"))
        ...
        #expect(gatewayConnectionFeature
            .contains("var discoveredGatewayConnectionStatusAction: OnboardingStatusFeature.Action?"))
        ...
        #expect(gatewayConnectionFeature.contains("var name: OnboardingDiscoveredGatewayName"))
        #expect(gatewayConnectionFeature.contains("case discoverySnapshotChanged(DiscoverySnapshot)"))
        #expect(gatewayConnectionFeature.contains("case discoveredGatewayConnectionRequested"))
        #expect(gatewayConnectionFeature.contains("case discoveredGatewayConnectionEffectRequested"))
        #expect(gatewayConnectionFeature.contains("case discoveredGatewayConnectionStatusHandled"))
        #expect(gatewayConnectionFeature.contains("OnboardingDiscoveredGatewayConnectionClient"))
        #expect(gatewayConnectionFeature.contains("@Dependency(\\.onboardingDiscoveredGatewayConnection)"))
        #expect(gatewayConnectionFeature.contains("await discoveredGatewayConnectionClient.connect(request.id)"))
        ...
        #expect(gatewayConnectionFeature.contains("state.discoveryStatusTextState = snapshot.statusText"))
        #expect(gatewayConnectionFeature.contains("state.discoveredGatewayRows = snapshot.rows"))
        #expect(gatewayConnectionFeature.contains("state.discoveredGatewayConnectionStatusAction = .connectionStarted(.init("))
        #expect(gatewayConnectionFeature.contains("message: .init(value: \"Connecting to \\(request.name.value)…\")"))
        #expect(gatewayConnectionFeature.contains("state.discoveredGatewayConnectionStatusAction = nil"))
        #expect(onboardingSource.contains("self.syncGatewayDiscoverySnapshot()"))
        #expect(onboardingSource.contains("self.gatewayConnectionStore.send(.discoverySnapshotChanged(.init("))
        #expect(onboardingSource.contains("statusText: .init(value: self.gatewayController.discoveryStatusText)"))
        #expect(onboardingSource.contains("rows: self.gatewayController.gateways.map(Self.discoveredGatewayRow)"))
        #expect(onboardingSource.contains("LabeledContent(\"Discovery\", value: self.gatewayConnectionStore.discoveryStatusText)"))
        #expect(onboardingSource.contains("if self.gatewayConnectionStore.discoveredGatewayRows.isEmpty"))
        #expect(onboardingSource.contains("ForEach(self.gatewayConnectionStore.discoveredGatewayRows)"))
        #expect(!onboardingSource.contains(
            "LabeledContent(\"Discovery\", value: self.gatewayController.discoveryStatusText)"))
        #expect(!onboardingSource.contains("if self.gatewayController.gateways.isEmpty"))
        #expect(!onboardingSource.contains("ForEach(self.gatewayController.gateways)"))
        ...
        #expect(connectFunction.contains("id: gateway.connectionID"))
        #expect(connectFunction.contains("name: gateway.name"))
        #expect(connectFunction.contains("self.gatewayConnectionStore.send(.discoveredGatewayConnectionRequested(request))"))
        #expect(connectFunction.contains("self.gatewayConnectionStore.discoveredGatewayConnectionStatusAction"))
        #expect(connectFunction.contains("self.gatewayConnectionStore.send(.discoveredGatewayConnectionStatusHandled)"))
        #expect(connectFunction.contains("self.statusStore.send(statusAction)"))
        #expect(connectFunction.contains("await self.gatewayConnectionStore.send(.discoveredGatewayConnectionEffectRequested"))
        #expect(!connectFunction.contains("await self.gatewayController.connect(gateway)"))
        #expect(!connectFunction.contains("self.statusStore.send(.connectionStarted(connectionStart))"))
        #expect(rowPresentationFunction.contains("gateway.presentation"))
        #expect(rowPresentationFunction.contains("connectionID: .init(value: gateway.id)"))
        #expect(rowPresentationFunction.contains("name: .init(value: gateway.name)"))
        #expect(rowPresentationFunction.contains("lanHost: .init(value: gateway.lanHost)"))
        #expect(rowPresentationFunction.contains("tailnetDNS: .init(value: gateway.tailnetDns)"))
    ...
    @Test func `onboarding connection start action is typed`() throws {
        ...
        #expect(onboardingStateSource.contains("struct RetryConnectionRequest: Equatable, Sendable"))
        ...
        #expect(onboardingStateSource.contains("static func retryConnectionRequest("))
        #expect(onboardingStateSource.contains("struct RetryConnectionRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("var silent: OnboardingRetryConnectionSilence"))
        ...
        #expect(retryFunction.contains("let request = OnboardingStatusFeature.retryConnectionRequest(silent: .init(value: silent))"))
        #expect(retryFunction.contains("await self.statusStore.send(.retryConnectionRequested(request)).finish()"))
        #expect(!retryFunction.contains("await self.gatewayController.connectLastKnown()"))
        #expect(!retryFunction.contains(
    ...
    @Test func `onboarding connection issue action is typed`() throws {
        ...
        #expect(onboardingStateSource.contains("struct AuthStepNavigationRequest: Equatable, Sendable"))
        #expect(onboardingStateSource.contains("var authStepNavigationRequest: AuthStepNavigationRequest?"))
        #expect(onboardingStateSource.contains("case authStepNavigationHandled"))
        ...
        #expect(onboardingSource.contains("if let request = self.statusStore.authStepNavigationRequest"))
        #expect(onboardingSource.contains("self.stepStore.send(request.stepAction)"))
        #expect(onboardingSource.contains("self.statusStore.send(.authStepNavigationHandled)"))
        ...
        #expect(!onboardingSource.contains("if self.statusStore.shouldShowAuthStep"))
    ...
    @Test func `onboarding gateway problem primary action is reducer decision owned`() throws {
        ...
        let actionPrefix = try Self.extract(
            ...
            from: "private func handleGatewayProblemPrimaryAction(_ problem: GatewayConnectionProblem) async",
            to: "        switch decision {")
        let trustCertificateAction = try Self.extract(
            onboardingSource,
            from: "case let .trustRotatedCertificate",
            to: "        case let .openProtocolMismatchHelp")
        ...
        #expect(onboardingFeatureSource.contains("id: .init(value: \"trust-certificate\")"))
        #expect(onboardingFeatureSource.contains("message: .init(value: \"Updating gateway certificate…\")"))
        #expect(onboardingFeatureSource.contains("statusLine: .init(value: \"Updating gateway certificate…\")"))
        #expect(onboardingFeatureSource.contains("clearsIssue: .init(value: false)"))
        ...
        #expect(!trustCertificateAction.contains("id: .init(value: \"trust-certificate\")"))
        #expect(!trustCertificateAction.contains("message: .init(value: \"Updating gateway certificate…\")"))
        #expect(!trustCertificateAction.contains("statusLine: .init(value: \"Updating gateway certificate…\")"))
    }
    ...
    @Test func `settings onboarding reset is reducer effect owned`() throws {
        ...
        #expect(settingsSource.contains("var hasConnectedOnceState = SettingsOnboardingHasConnectedOnce(value: false)"))
        #expect(settingsSource.contains("var onboardingCompletion = SettingsOnboardingComplete(value: false)"))
        #expect(!settingsSource.contains("Action.SettingsOnboardingHasConnectedOnce"))
        #expect(!settingsSource.contains("Action.SettingsOnboardingComplete"))
    ...
    @Test func `settings talk toggle apple review decision is reducer owned`() throws {
        ...
        #expect(settingsSource.contains("SettingsTalkEnabled(isEnabled: false)"))
    ...
    @Test func `settings voice control persistence is reducer effect owned`() throws {
        ...
        #expect(settingsSource.contains("var talkEnabled = SettingsTalkEnabled(isEnabled: false)"))
        #expect(settingsSource.contains("var voiceWakeEnabled = SettingsVoiceWakeEnabled(isEnabled: false)"))
        #expect(settingsSource.contains("var voiceWakeStatusText = SettingsVoiceWakeStatusText(value: \"Off\")"))
        #expect(!settingsSource.contains("Action.SettingsTalkEnabled"))
        #expect(!settingsSource.contains("Action.SettingsVoiceWakeEnabled"))
        #expect(!settingsSource.contains("Action.SettingsVoiceWakeStatusText"))
    ...
    @Test func `settings discovery debug logging is reducer effect owned`() throws {
        ...
        #expect(settingsSource.contains("var discoveryDebugLogs = SettingsDebugOptionEnabled(isEnabled: false)"))
        #expect(settingsSource.contains("var canvasDebugStatus = SettingsDebugOptionEnabled(isEnabled: false)"))
        #expect(!settingsSource.contains("Action.SettingsDebugOptionEnabled"))
    ...
    @Test func `home canvas payload state is reducer owned`() throws {
        ...
        let snapshotSource = try Self.extract(
            featureSource,
            from: "struct Snapshot: Equatable, Sendable {",
            to: "struct AgentSnapshot")
        let agentSnapshotSource = try Self.extract(
            featureSource,
        ...
        #expect(featureSource.contains("struct GatewayServerName: Equatable, Sendable"))
        #expect(featureSource.contains("struct GatewayRemoteAddress: Equatable, Sendable"))
        #expect(featureSource.contains("struct SelectedAgentID: Equatable, Sendable"))
        #expect(featureSource.contains("struct GatewayDefaultAgentID: Equatable, Sendable"))
        #expect(featureSource.contains("struct ActiveAgentName: Equatable, Sendable"))
        #expect(featureSource.contains("struct AgentID: Equatable, Sendable"))
        #expect(featureSource.contains("struct AgentName: Equatable, Sendable"))
        #expect(featureSource.contains("struct AgentEmoji: Equatable, Sendable"))
        #expect(snapshotSource.contains("var gatewayServerName: GatewayServerName"))
        #expect(snapshotSource.contains("var gatewayRemoteAddress: GatewayRemoteAddress"))
        #expect(snapshotSource.contains("var selectedAgentID: SelectedAgentID"))
        #expect(snapshotSource.contains("var gatewayDefaultAgentID: GatewayDefaultAgentID"))
        #expect(snapshotSource.contains("var activeAgentName: ActiveAgentName"))
        #expect(agentSnapshotSource.contains("var id: AgentID"))
        #expect(agentSnapshotSource.contains("var name: AgentName"))
        #expect(agentSnapshotSource.contains("var emoji: AgentEmoji"))
        ...
        #expect(featureSource.contains("let gatewayName = self.normalized(snapshot.gatewayServerName.value)"))
        #expect(featureSource.contains("let gatewayAddress = self.normalized(snapshot.gatewayRemoteAddress.value)"))
        #expect(featureSource.contains("activeAgentName: snapshot.activeAgentName.value"))
        #expect(featureSource.contains("self.normalized(snapshot.selectedAgentID.value)"))
        #expect(featureSource.contains("self.normalized(snapshot.gatewayDefaultAgentID.value)"))
        #expect(featureSource.contains("let isActive = !activeAgentID.isEmpty && agent.id.value == activeAgentID"))
        #expect(featureSource.contains("let isDefault = !defaultAgentID.isEmpty && agent.id.value == defaultAgentID"))
        #expect(featureSource.contains("id: agent.id.value"))
        #expect(featureSource.contains("self.normalized(agent.name.value) ?? agent.id.value"))
        #expect(featureSource.contains("normalized(agent.emoji.value)"))
        ...
        #expect(featureSource.contains("gatewayServerName: .init(value: appModel.gatewayServerName)"))
        #expect(featureSource.contains("gatewayRemoteAddress: .init(value: appModel.gatewayRemoteAddress)"))
        #expect(featureSource.contains("selectedAgentID: .init(value: appModel.selectedAgentId)"))
        #expect(featureSource.contains("gatewayDefaultAgentID: .init(value: appModel.gatewayDefaultAgentId)"))
        #expect(featureSource.contains("activeAgentName: .init(value: appModel.activeAgentName)"))
        ...
        #expect(featureSource.contains("id: .init(value: agent.id)"))
        ...
        #expect(!snapshotSource.contains("var gatewayServerName: String?"))
        #expect(!snapshotSource.contains("var gatewayRemoteAddress: String?"))
        #expect(!snapshotSource.contains("var selectedAgentID: String?"))
        #expect(!snapshotSource.contains("var gatewayDefaultAgentID: String?"))
        #expect(!snapshotSource.contains("var activeAgentName: String"))
        #expect(!agentSnapshotSource.contains("var id: String"))
        #expect(!agentSnapshotSource.contains("var name: String?"))
        #expect(!agentSnapshotSource.contains("var emoji: String?"))
        #expect(!featureSource.contains("gatewayServerName: appModel.gatewayServerName"))
        #expect(!featureSource.contains("gatewayRemoteAddress: appModel.gatewayRemoteAddress"))
        #expect(!featureSource.contains("selectedAgentID: appModel.selectedAgentId"))
        #expect(!featureSource.contains("gatewayDefaultAgentID: appModel.gatewayDefaultAgentId"))
        #expect(!featureSource.contains("activeAgentName: appModel.activeAgentName"))
        #expect(!featureSource.contains("let isActive = !activeAgentID.isEmpty && agent.id == activeAgentID"))
        #expect(!featureSource.contains("let isDefault = !defaultAgentID.isEmpty && agent.id == defaultAgentID"))
        #expect(!featureSource.contains("id: agent.id,\n"))
        #expect(!featureSource.contains("self.normalized(agent.name) ?? agent.id"))
        #expect(!featureSource.contains("normalized(agent.emoji)"))
    ...
    private static func onboardingCredentialsFeatureSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Onboarding/OnboardingCredentialsFeature.swift")
    }
