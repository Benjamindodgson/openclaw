...
struct RootTabsSourceGuardTests {
    ...
    @Test func `workboard card presentation is reducer owned`() throws {
        ...
        #expect(detailSheetSource.contains("Section(self.presentation.detailSectionTitle)"))
        #expect(detailSheetSource.contains("LabeledContent(self.presentation.titleFieldTitle"))
        #expect(detailSheetSource.contains("LabeledContent(self.presentation.statusFieldTitle"))
        #expect(detailSheetSource.contains("Section(self.presentation.actionsSectionTitle)"))
        #expect(detailSheetSource.contains(".navigationTitle(self.presentation.detailSheetTitle)"))
        #expect(detailSheetSource.contains("Button(self.presentation.doneActionTitle)"))
