...
struct RootTabsSourceGuardTests {
    ...
    @Test func `agent dreaming maintenance response action is typed`() throws {
        ...
        #expect(feature.contains("struct DreamActionSummary: Equatable, Sendable"))
        ...
        #expect(feature.contains("await send(.dreamActionResponse(.init(result: .success(.init(summary: summary)))))"))
