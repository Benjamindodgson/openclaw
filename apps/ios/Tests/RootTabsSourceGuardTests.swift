...
struct RootTabsSourceGuardTests {
    ...
    @Test func `onboarding connection start action is typed`() throws {
        ...
        #expect(onboardingStateSource.contains("statusAction: .retryConnectionStarted(.init(silent: silent))"))
        ...
        #expect(retryFunction.contains("self.statusStore.send(request.statusAction)"))
