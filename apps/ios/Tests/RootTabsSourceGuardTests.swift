...
struct RootTabsSourceGuardTests {
    ...
    @Test func `workboard create action surfaces unavailable reasons`() throws {
        ...
        #expect(source.contains("showsWriteControls: canWrite"))
        #expect(source.contains("unavailablePresentation: self.compactWriteUnavailablePresentation(canRead: canRead)"))
        ...
        #expect(source.contains("self.store.state.compactEmptyStatePresentation(canRead: self.gatewayAccess.canRead)"))
        #expect(source.contains("self.store.state.compactWriteControlsPresentation("))
        #expect(source.contains("canRead: self.gatewayAccess.canRead"))
        #expect(source.contains("canWrite: self.gatewayAccess.canWrite"))
